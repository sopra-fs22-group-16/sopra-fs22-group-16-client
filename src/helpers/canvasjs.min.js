...
/*eslint-disable*/
/*jshint ignore:start*/
(function(){function na(h,m){h.prototype=cb(m.prototype);h.prototype.constructor=h;h.base=m.prototype}function cb(h){function m(){}m.prototype=h;return new m}function Va(h,m,v){"millisecond"===v?h.setMilliseconds(h.getMilliseconds()+1*m):"second"===v?h.setSeconds(h.getSeconds()+1*m):"minute"===v?h.setMinutes(h.getMinutes()+1*m):"hour"===v?h.setHours(h.getHours()+1*m):"day"===v?h.setDate(h.getDate()+1*m):"week"===v?h.setDate(h.getDate()+7*m):"month"===v?h.setMonth(h.getMonth()+1*m):"year"===v&&h.setFullYear(h.getFullYear()+
1*m);return h}function Z(h,m){var v=!1;0>h&&(v=!0,h*=-1);h=""+h;for(m=m?m:1;h.length<m;)h="0"+h;return v?"-"+h:h}function Fa(h){if(!h)return h;h=h.replace(/^\s\s*/,"");for(var m=/\s/,v=h.length;m.test(h.charAt(--v)););return h.slice(0,v+1)}function Ba(h){h.roundRect=function(h,v,s,w,pa,E,x,F){x&&(this.fillStyle=x);F&&(this.strokeStyle=F);"undefined"===typeof pa&&(pa=5);this.lineWidth=E;this.beginPath();this.moveTo(h+pa,v);this.lineTo(h+s-pa,v);this.quadraticCurveTo(h+s,v,h+s,v+pa);this.lineTo(h+s,
v+w-pa);this.quadraticCurveTo(h+s,v+w,h+s-pa,v+w);this.lineTo(h+pa,v+w);this.quadraticCurveTo(h,v+w,h,v+w-pa);this.lineTo(h,v+pa);this.quadraticCurveTo(h,v,h+pa,v);this.closePath();x&&this.fill();F&&0<E&&this.stroke()}}function Pa(h,m){return h-m}function Q(h){var m=((h&16711680)>>16).toString(16),v=((h&65280)>>8).toString(16);h=((h&255)>>0).toString(16);m=2>m.length?"0"+m:m;v=2>v.length?"0"+v:v;h=2>h.length?"0"+h:h;return"#"+m+v+h}function db(h,m){var v=this.length>>>0,s=Number(m)||0,s=0>s?Math.ceil(s):
Math.floor(s);for(0>s&&(s+=v);s<v;s++)if(s in this&&this[s]===h)return s;return-1}function s(h){return null===h||"undefined"===typeof h}function Ca(h){h.indexOf||(h.indexOf=db);return h}function eb(h){if(J.fSDec)h[ha("`eeDwdouMhrudods")](ha("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){J._fTWm&&J._fTWm(h)})}function Wa(h,m,v){v=v||"normal";var s=h+"_"+m+"_"+v,w=Xa[s];if(isNaN(w)){try{if(!va){var pa=document.body;va=document.createElement("span");va.innerHTML="";var E=document.createTextNode("Mpgyi");va.appendChild(E);
pa.appendChild(va)}va.style.display="";U(va,{position:"absolute",left:"0px",top:"-20000px",padding:"0px",margin:"0px",border:"none",whiteSpace:"pre",lineHeight:"normal",fontFamily:h,fontSize:m+"px",fontWeight:v});w=Math.round(va.offsetHeight);va.style.display="none"}catch(x){w=Math.ceil(1.1*m)}w=Math.max(w,m);Xa[s]=w}return w}function O(h,m){var v=[];if(v={solid:[],shortDash:[3,1],shortDot:[1,1],shortDashDot:[3,1,1,1],shortDashDotDot:[3,1,1,1,1,1],dot:[1,2],dash:[4,2],dashDot:[4,2,1,2],longDash:[8,
2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[h||"solid"])for(var s=0;s<v.length;s++)v[s]*=m;else v=[];return v}function V(h,m,v,w,sa){w=w||[];sa=s(sa)?fb?{passive:!1,capture:!1}:!1:sa;w.push([h,m,v,sa]);return h.addEventListener?(h.addEventListener(m,v,sa),v):h.attachEvent?(w=function(m){m=m||window.event;m.preventDefault=m.preventDefault||function(){m.returnValue=!1};m.stopPropagation=m.stopPropagation||function(){m.cancelBubble=!0};v.call(h,m)},h.attachEvent("on"+m,w),w):!1}function gb(h){if(h._menuButton)h.exportEnabled?
(U(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor}),Ka(h._menuButton),h._menuButton.title=h._cultureInfo.menuText):ta(h._menuButton);else if(h.exportEnabled&&w){var m=!1;h._menuButton=document.createElement("button");ua(h,h._menuButton,"menu");h._toolBar.appendChild(h._menuButton);V(h._menuButton,"touchstart",function(h){m=!0},h.allDOMEventHandlers);V(h._menuButton,"click",function(){"none"!==h._dropdownMenu.style.display||h._dropDownCloseTime&&500>=(new Date).getTime()-
h._dropDownCloseTime.getTime()||(h._dropdownMenu.style.display="block",h._menuButton.blur(),h._dropdownMenu.focus())},h.allDOMEventHandlers,!0);V(h._menuButton,"mousemove",function(){m||(U(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColorOnHover,color:h.toolbar.fontColorOnHover}),0>=navigator.userAgent.search("MSIE")&&U(h._menuButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},h.allDOMEventHandlers,!0);V(h._menuButton,"mouseout",function(){m||(U(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,
...
textAlign:"left",lineHeight:"10px",backgroundColor:h.toolbar.itemBackgroundColor,boxShadow:"2px 2px 10px"+v}),h._dropdownMenu.style.display="none",h._toolBar.appendChild(h._dropdownMenu),V(h._dropdownMenu,"blur",function(){ta(h._dropdownMenu);h._dropDownCloseTime=new Date},h.allDOMEventHandlers,!0),v=document.createElement("div"),U(v,{padding:"12px 8px 12px 8px"}),v.innerHTML=h._cultureInfo.printText,v.style.backgroundColor=h.toolbar.itemBackgroundColor,v.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(v),
V(v,"touchstart",function(h){m=!0},h.allDOMEventHandlers),V(v,"mousemove",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),V(v,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),V(v,"click",function(){h.print();ta(h._dropdownMenu)},h.allDOMEventHandlers,!0),v=document.createElement("div"),U(v,{padding:"12px 8px 12px 8px"}),
v.innerHTML=h._cultureInfo.saveJPGText,v.style.backgroundColor=h.toolbar.itemBackgroundColor,v.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(v),V(v,"touchstart",function(h){m=!0},h.allDOMEventHandlers),V(v,"mousemove",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),V(v,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},
h.allDOMEventHandlers,!0),V(v,"click",function(){h.exportChart({format:"jpeg",fileName:h.exportFileName});ta(h._dropdownMenu)},h.allDOMEventHandlers,!0),v=document.createElement("div"),U(v,{padding:"12px 8px 12px 8px"}),v.innerHTML=h._cultureInfo.savePNGText,v.style.backgroundColor=h.toolbar.itemBackgroundColor,v.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(v),V(v,"touchstart",function(h){m=!0},h.allDOMEventHandlers),V(v,"mousemove",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,
this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),V(v,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),V(v,"click",function(){h.exportChart({format:"png",fileName:h.exportFileName});ta(h._dropdownMenu)},h.allDOMEventHandlers,!0))}function Ya(h,m,v){h*=ka;m*=ka;h=v.getImageData(h,m,2,2).data;m=!0;for(v=0;4>v;v++)if(h[v]!==h[v+4]|h[v]!==h[v+8]|h[v]!==h[v+12]){m=!1;break}return m?
h[0]<<16|h[1]<<8|h[2]:0}function la(h,m,v){return h in m?m[h]:v[h]}function La(h,m,v){if(w&&Za){var s=h.getContext("2d");Ma=s.webkitBackingStorePixelRatio||s.mozBackingStorePixelRatio||s.msBackingStorePixelRatio||s.oBackingStorePixelRatio||s.backingStorePixelRatio||1;ka=Qa/Ma;h.width=m*ka;h.height=v*ka;Qa!==Ma&&(h.style.width=m+"px",h.style.height=v+"px",s.scale(ka,ka))}else h.width=m,h.height=v}function hb(h){if(!ib){var m=!1,v=!1;"undefined"===typeof oa.Chart.creditHref?(h.creditHref=ha("iuuqr;..b`ow`rkr/bnl."),
...
h._creditLink.setAttribute("tabIndex",-1),h._creditLink.setAttribute("target","_blank"));if(0===h.renderCount||m||v)h._creditLink.setAttribute("href",h.creditHref),h._creditLink.innerHTML=h.creditText;h._creditLink&&h.creditHref&&h.creditText?(h._creditLink.parentElement||h._canvasJSContainer.appendChild(h._creditLink),h._creditLink.style.top=h.height-14+"px"):h._creditLink.parentElement&&h._canvasJSContainer.removeChild(h._creditLink)}}}function ra(h,m){Ga&&(this.canvasCount|=0,window.console.log(++this.canvasCount));
var v=document.createElement("canvas");v.setAttribute("class","canvasjs-chart-canvas");La(v,h,m);w||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(v);return v}function U(h,m){for(var v in m)h.style[v]=m[v]}function ua(h,m,v){m.getAttribute("state")||(m.style.backgroundColor=h.toolbar.itemBackgroundColor,m.style.color=h.toolbar.fontColor,m.style.border="none",U(m,{WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));m.getAttribute("state")!==
v&&(m.setAttribute("state",v),m.setAttribute("type","button"),U(m,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),m.setAttribute("title",h._cultureInfo[v+"Text"]),m.innerHTML="<img src='"+jb[v].image+"' alt='"+h._cultureInfo[v+"Text"]+"' />",U(m.childNodes[0],{height:"95%",pointerEvents:"none"}))}function Ka(){for(var h=null,m=0;m<arguments.length;m++)h=arguments[m],h.style&&(h.style.display="inline")}function ta(){for(var h=
null,m=0;m<arguments.length;m++)(h=arguments[m])&&h.style&&(h.style.display="none")}function Ra(h,m,v,s,w){if(null===h||"undefined"===typeof h)return"undefined"===typeof v?m:v;h=parseFloat(h.toString())*(0<=h.toString().indexOf("%")?m/100:1);"undefined"!==typeof s&&(h=Math.min(s,h),"undefined"!==typeof w&&(h=Math.max(w,h)));return!isNaN(h)&&h<=m&&0<=h?h:"undefined"===typeof v?m:v}function T(h,m,v,w,x){this._defaultsKey=h;this._themeOptionsKey=m;this._index=w;this.parent=x;this._eventListeners=[];
...
spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:x,titleFontSize:X,titleFontColor:ca,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,
labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:W,color:ga,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:x,titleFontSize:X,titleFontColor:ca,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:x,
labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:W,color:ga,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:x,titleFontSize:X,titleFontColor:ca,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,
...
lineDashType:"solid"}}],axisX2:[{titleFontFamily:x,titleFontSize:X,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:1,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,
labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:x,titleFontSize:X,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",
stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:x,titleFontSize:X,titleFontColor:"#666666",titleFontWeight:"normal",
...
ga="#40BAF1";W="#F5F5F5";X=20;F=14;Ea={colorSet:"colorSet12",backgroundColor:"#2A2A2A",title:{fontFamily:Ea,fontSize:32,fontColor:ca,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Ea,fontSize:F,fontColor:ca,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:x,indexLabelFontSize:F,
indexLabelFontColor:S,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:X,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,
labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:ga,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:x,titleFontSize:X,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:x,
labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:ga,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:x,titleFontSize:X,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,
labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:ga,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,
lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:x,titleFontSize:X,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#000000",
labelFontWeight:"normal",labelBackgroundColor:W,color:ga,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:x,fontSize:14,fontColor:ca,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:x,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:S,backgroundColor:"rgba(0, 0, 0, .7)"}};H="#FFFFFF";S=ca="#FAFAFA";ga="#40BAF1";W="#F5F5F5";
var X=20,F=14,ab={light1:Ua,light2:$a,dark1:Ea,dark2:{colorSet:"colorSet2",backgroundColor:"#32373A",title:{fontFamily:x,fontSize:32,fontColor:ca,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:x,fontSize:F,fontColor:ca,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:x,
indexLabelFontSize:F,indexLabelFontColor:S,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:X,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,
labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:ga,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:x,titleFontSize:X,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:x,
labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:ga,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:x,titleFontSize:X,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,
labelFontColor:S,labelFontWeight:"normal",lineThickness:0,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:ga,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,
lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:x,titleFontSize:X,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:0,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#000000",
...
227,183,225,212,213])];J.pro={sCH:oa[J.fSDec([178,215,208,225,227])][J.fSDec([210,225,212,211,216,227,183,225,212,213])]};J._fTWm=function(h){if("undefined"===typeof J.pro.sCH&&!bb){var m=h[J.fSDec(J.str.ct)];m[J.fSDec(J.str.tBl)]=J.fSDec(J.str.tp);m[J.fSDec(J.str.fnt)]=11+J.fSDec(J.str.fntStr);m[J.fSDec(J.str.fSy)]=J.fSDec(J.str.gr);m[J.fSDec(J.str.fTx)](J.fSDec(J.str.ncv),2,h.height-11-2)}}})();var fb=function(){var h=!1;try{var m=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){h=
!0;return!1}});window.addEventListener&&(window.addEventListener("test",null,m),window.removeEventListener("test",null,m))}catch(v){h=!1}return h}(),Xa={},va=null,kb=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))},xa=function(h){h.width=1;h.height=1;h.getContext("2d")&&h.getContext("2d").clearRect(0,0,1,1)},lb=function(h,m,v){m=Math.min(this.width,this.height);return Math.max("theme4"===
this.theme?0:300<=m?12:11,Math.round(m*(h/400)))},Aa=function(){var h=/D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,m="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),v="Sun Mon Tue Wed Thu Fri Sat".split(" "),s="January February March April May June July August September October November December".split(" "),w="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),x=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,
E=/[^-+\dA-Z]/g;return function(F,O,N){var H=N?N.days:m,Q=N?N.months:s,V=N?N.shortDays:v,R=N?N.shortMonths:w;N="";var J=!1;F=F&&F.getTime?F:F?new Date(F):new Date;if(isNaN(F))throw SyntaxError("invalid date");"UTC:"===O.slice(0,4)&&(O=O.slice(4),J=!0);N=J?"getUTC":"get";var U=F[N+"Date"](),L=F[N+"Day"](),$=F[N+"Month"](),a=F[N+"FullYear"](),d=F[N+"Hours"](),c=F[N+"Minutes"](),b=F[N+"Seconds"](),e=F[N+"Milliseconds"](),f=J?0:F.getTimezoneOffset();return N=O.replace(h,function(l){switch(l){case "D":return U;
case "DD":return Z(U,2);case "DDD":return V[L];case "DDDD":return H[L];case "M":return $+1;case "MM":return Z($+1,2);case "MMM":return R[$];case "MMMM":return Q[$];case "Y":return parseInt(String(a).slice(-2));case "YY":return Z(String(a).slice(-2),2);case "YYY":return Z(String(a).slice(-3),3);case "YYYY":return Z(a,4);case "h":return d%12||12;case "hh":return Z(d%12||12,2);case "H":return d;case "HH":return Z(d,2);case "m":return c;case "mm":return Z(c,2);case "s":return b;case "ss":return Z(b,2);
case "f":return Z(String(e),3).slice(0,1);case "ff":return Z(String(e),3).slice(0,2);case "fff":return Z(String(e),3).slice(0,3);case "t":return 12>d?"a":"p";case "tt":return 12>d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return J?"UTC":(String(F).match(x)||[""]).pop().replace(E,"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+Z(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+Z(Math.floor(Math.abs(f)/60),2)+
Z(Math.abs(f)%60,2);default:return l.slice(1,l.length-1)}})}}(),da=function(h,m,v){if(null===h)return"";if(!isFinite(h))return h;h=Number(h);var s=0>h?!0:!1;s&&(h*=-1);var w=v?v.decimalSeparator:".",x=v?v.digitGroupSeparator:",",E="";m=String(m);var E=1,F=v="",O=-1,N=[],H=[],Q=0,J=0,V=0,R=!1,U=0,F=m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);m=null;for(var L=0;F&&L<F.length;L++)if(m=F[L],"."===m&&0>O)O=L;else{if("%"===m)E*=100;else if("\u2030"===m){E*=1E3;continue}else if(","===m[0]&&
"."===m[m.length-1]){E/=Math.pow(1E3,m.length-1);O=L+m.length-1;continue}else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||(R=!0);0>O?(N.push(m),"#"===m||"0"===m?Q++:","===m&&V++):(H.push(m),"#"!==m&&"0"!==m||J++)}R&&(m=Math.floor(h),F=-Math.floor(Math.log(h)/Math.LN10+1),U=0===h?0:0===m?-(Q+F):String(m).length-Q,E/=Math.pow(10,U));0>O&&(O=L);E=(h*E).toFixed(J);m=E.split(".");E=(m[0]+"").split("");h=(m[1]+"").split("");E&&"0"===E[0]&&E.shift();for(R=F=L=J=O=0;0<N.length;)if(m=N.pop(),"#"===m||"0"===
m)if(O++,O===Q){var $=E,E=[];if("0"===m)for(m=Q-J-($?$.length:0);0<m;)$.unshift("0"),m--;for(;0<$.length;)v=$.pop()+v,R++,0===R%F&&(L===V&&0<$.length)&&(v=x+v)}else 0<E.length?(v=E.pop()+v,J++,R++):"0"===m&&(v="0"+v,J++,R++),0===R%F&&(L===V&&0<E.length)&&(v=x+v);else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?","===m?(L++,F=R,R=0,0<E.length&&(v=x+v)):v=1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?m.slice(1,m.length-1)+v:m+v:(m=0>U?m.replace("+",
"").replace("-",""):m.replace("-",""),v+=m.replace(/[0]+/,function(a){return Z(U,a.length)}));x="";for(N=!1;0<H.length;)m=H.shift(),"#"===m||"0"===m?0<h.length&&0!==Number(h.join(""))?(x+=h.shift(),N=!0):"0"===m&&(x+="0",N=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?x+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?x+=m:(m=0>U?m.replace("+","").replace("-",""):m.replace("-",""),x+=m.replace(/[0]+/,function(a){return Z(U,
a.length)}));v+=(N?w:"")+x;return s?"-"+v:v},Na=function(h){var m=0,v=0;h=h||window.event;h.offsetX||0===h.offsetX?(m=h.offsetX,v=h.offsetY):h.layerX||0==h.layerX?(m=h.layerX,v=h.layerY):(m=h.pageX-h.target.offsetLeft,v=h.pageY-h.target.offsetTop);return{x:m,y:v}},Za=!0,Qa=window.devicePixelRatio||1,Ma=1,ka=Za?Qa/Ma:1,ea=function(h,m,v,s,w,x,E,F,O,N,R,Q,H){"undefined"===typeof H&&(H=1);E=E||0;F=F||"black";var J=15<s-m&&15<w-v?8:0.35*Math.min(s-m,w-v);h.beginPath();h.moveTo(m,v);h.save();h.fillStyle=
x;h.globalAlpha=H;h.fillRect(m,v,s-m,w-v);h.globalAlpha=1;0<E&&(H=0===E%2?0:0.5,h.beginPath(),h.lineWidth=E,h.strokeStyle=F,h.moveTo(m,v),h.rect(m-H,v-H,s-m+2*H,w-v+2*H),h.stroke());h.restore();!0===O&&(h.save(),h.beginPath(),h.moveTo(m,v),h.lineTo(m+J,v+J),h.lineTo(s-J,v+J),h.lineTo(s,v),h.closePath(),E=h.createLinearGradient((s+m)/2,v+J,(s+m)/2,v),E.addColorStop(0,x),E.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=E,h.fill(),h.restore());!0===N&&(h.save(),h.beginPath(),h.moveTo(m,w),h.lineTo(m+
J,w-J),h.lineTo(s-J,w-J),h.lineTo(s,w),h.closePath(),E=h.createLinearGradient((s+m)/2,w-J,(s+m)/2,w),E.addColorStop(0,x),E.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=E,h.fill(),h.restore());!0===R&&(h.save(),h.beginPath(),h.moveTo(m,v),h.lineTo(m+J,v+J),h.lineTo(m+J,w-J),h.lineTo(m,w),h.closePath(),E=h.createLinearGradient(m+J,(w+v)/2,m,(w+v)/2),E.addColorStop(0,x),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,h.fill(),h.restore());!0===Q&&(h.save(),h.beginPath(),h.moveTo(s,
v),h.lineTo(s-J,v+J),h.lineTo(s-J,w-J),h.lineTo(s,w),E=h.createLinearGradient(s-J,(w+v)/2,s,(w+v)/2),E.addColorStop(0,x),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,E.addColorStop(0,x),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,h.fill(),h.closePath(),h.restore())},ha=function(h){for(var m="",s=0;s<h.length;s++)m+=String.fromCharCode(Math.ceil(h.length/57/5)^h.charCodeAt(s));return m},bb=window&&window[ha("mnb`uhno")]&&window[ha("mnb`uhno")].href&&window[ha("mnb`uhno")].href.indexOf&&
...
T.prototype.setOptions=function(h,m){if(oa[this._defaultsKey]){var s=oa[this._defaultsKey],w;for(w in s)"publicProperties"!==w&&s.hasOwnProperty(w)&&(this[w]=h&&w in h?h[w]:m&&w in m?m[w]:s[w])}else Ga&&window.console&&console.log("defaults not set")};T.prototype.get=function(h){var m=oa[this._defaultsKey];if("options"===h)return this.options&&this.options._isPlaceholder?null:this.options;if(m.hasOwnProperty(h)||m.publicProperties&&m.publicProperties.hasOwnProperty(h))return this[h];window.console&&
window.console.log('Property "'+h+"\" doesn't exist. Please check for typo.")};T.prototype.set=function(h,m,s){s="undefined"===typeof s?!0:s;var w=oa[this._defaultsKey];if("options"===h)this.createUserOptions(m);else if(w.hasOwnProperty(h)||w.publicProperties&&w.publicProperties.hasOwnProperty(h)&&"readWrite"===w.publicProperties[h])this.options._isPlaceholder&&this.createUserOptions(),this.options[h]=m;else{window.console&&(w.publicProperties&&w.publicProperties.hasOwnProperty(h)&&"readOnly"===w.publicProperties[h]?
...
m=s):m=void 0,h[m]=this.options};T.prototype.remove=function(h){h="undefined"===typeof h?!0:h;if(this.isOptionsInArray){var m=this.parent.options[this.optionsName];Ca(m);var s=m.indexOf(this.options);0<=s&&m.splice(s,1)}else delete this.parent.options[this.optionsName];h&&(this.stockChart||this.chart||this).render()};T.prototype.updateOption=function(h){!oa[this._defaultsKey]&&(Ga&&window.console)&&console.log("defaults not set");var m=oa[this._defaultsKey],w={},x=this[h],F=this._themeOptionsKey,
...
null};ia.prototype.measureText=function(){this._lineHeight=Wa(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ia.prototype._getLineWithWidth=function(h,m,s){h=String(h);if(!h)return{text:"",width:0};var w=s=0,x=h.length-1,F=Infinity;for(this.ctx.font=this._getFontString();w<=x;){var F=Math.floor((w+x)/2),E=h.substr(0,F+1);s=this.ctx.measureText(E).width;
if(s<m)w=F+1;else if(s>m)x=F-1;else break}s>m&&1<E.length&&(E=E.substr(0,E.length-1),s=this.ctx.measureText(E).width);m=!0;if(E.length===h.length||" "===h[E.length])m=!1;m&&(h=E.split(" "),1<h.length&&h.pop(),E=h.join(" "),s=this.ctx.measureText(E).width);return{text:E,width:s}};ia.prototype._wrapText=function(){var h=new String(Fa(String(this.text))),m=[],s=this.ctx.font,w=0,x=0;this.ctx.font=this._getFontString();if(0===this.frontSize)x=w=0;else for(;0<h.length;){var F=this.maxHeight-(this.topPadding+
this.bottomPadding),E=this._getLineWithWidth(h,this.maxWidth-(this.leftPadding+this.rightPadding),!1);E.height=this._lineHeight;m.push(E);var J=x,x=Math.max(x,E.width),w=w+E.height,h=Fa(h.slice(E.text.length,h.length));F&&w>F&&(E=m.pop(),w-=E.height,x=J)}this._wrappedText={lines:m,width:x,height:w};this.width=x+(this.leftPadding+this.rightPadding);this.height=w+(this.topPadding+this.bottomPadding);this.ctx.font=s};ia.prototype._getFontString=function(){var h;h=""+(this.fontStyle?this.fontStyle+" ":
"");h+=this.fontWeight?this.fontWeight+" ":"";h+=this.fontSize?this.fontSize+"px ":"";var m=this.fontFamily?this.fontFamily+"":"";!w&&m&&(m=m.split(",")[0],"'"!==m[0]&&'"'!==m[0]&&(m="'"+m+"'"));return h+=m};na(Sa,T);na(ya,T);ya.prototype.setLayout=function(){if(this.text){var h=this.dockInsidePlotArea?this.chart.plotArea:this.chart,m=h.layoutManager.getFreeSpace(),w=m.x1,x=m.y1,F=0,J=0,E=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,O,H;"top"===this.verticalAlign||
...
w;J.y=x;J.angle=F;J.horizontalAlign=O;this._textBlock=J;h.layoutManager.registerSpace(H,{width:this.width+("left"===H||"right"===H?this.margin+2:0),height:this.height+("top"===H||"bottom"===H?this.margin+2:0)});this.bounds={x1:w,y1:x,x2:w+this.width,y2:x+this.height};this.ctx.textBaseline="top"}};ya.prototype.render=function(){this._textBlock&&this._textBlock.render(!0)};na(Ha,T);Ha.prototype.setLayout=ya.prototype.setLayout;Ha.prototype.render=ya.prototype.render;Ta.prototype.get=function(h,m){var s=
null;0<this.pool.length?(s=this.pool.pop(),La(s,h,m)):s=ra(h,m);return s};Ta.prototype.release=function(h){this.pool.push(h)};na(Ia,T);var Oa={addTheme:function(h,m){ab[h]=m},addColorSet:function(h,m){za[h]=m},addCultureInfo:function(h,m){Ja[h]=m},formatNumber:function(h,m,s){s=s||"en";if(Ja[s])return da(h,m||"#,##0.##",new Ia(s));throw"Unknown Culture Name";},formatDate:function(h,m,s){s=s||"en";if(Ja[s])return Aa(h,m||"DD MMM YYYY",new Ia(s));throw"Unknown Culture Name";}};"undefined"!==typeof module&&
"undefined"!==typeof module.exports?module.exports=Oa:"function"===typeof define&&define.amd?define([],function(){return Oa}):(window.CanvasJS&&window.console&&window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."),window.CanvasJS=window.CanvasJS?window.CanvasJS:Oa);x=Oa.Chart=function(){function h(a,d){return a.x-d.x}function m(a,d,c){d=d||{};s(c)?(this.predefinedThemes=ab,this.optionsName=
...
"top",Ba(this.overlaidCanvasCtx)),this._eventManager=new ga(this),this.windowResizeHandler=V(window,"resize",function(){b._updateSize()&&b.render()},this.allDOMEventHandlers),this._toolBar=document.createElement("div"),this._toolBar.setAttribute("class","canvasjs-chart-toolbar"),U(this._toolBar,{position:"absolute",right:"1px",top:"1px"}),this._canvasJSContainer.appendChild(this._toolBar),this.bounds={x1:0,y1:0,x2:this.width,y2:this.height},V(this.overlaidCanvas,"click",function(a){b._mouseEventHandler(a)},
...
2+1;var B=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[t].x>a[f].x&&0<B||a[t].x<a[f].x&&0>B?{x:a[t].x+B/3,y:a[t].y+b/3}:{x:a[t].x,y:a[t].y+b/9};t=e;f=0===t?0:t-1;l=t===a.length-1?t:t+1;b=Math.abs((a[l].x-a[f].x)/(0===a[t].x-a[f].x?0.01:a[t].x-a[f].x))*(d-1)/2+1;B=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[t].x>a[f].x&&0<B||a[t].x<a[f].x&&0>B?{x:a[t].x-B/3,y:a[t].y-b/3}:{x:a[t].x,y:a[t].y-b/9};c[c.length]=a[e]}return c}function x(a,d,c,b,e,f,l,t,B,k){var n=0;k?(l.color=f,t.color=f):
k=1;n=B?Math.abs(e-c):Math.abs(b-d);n=0<l.trimLength?Math.abs(n*l.trimLength/100):Math.abs(n-l.length);B?(c+=n/2,e-=n/2):(d+=n/2,b-=n/2);var n=1===Math.round(l.thickness)%2?0.5:0,p=1===Math.round(t.thickness)%2?0.5:0;a.save();a.globalAlpha=k;a.strokeStyle=t.color||f;a.lineWidth=t.thickness||2;a.setLineDash&&a.setLineDash(O(t.dashType,t.thickness));a.beginPath();B&&0<t.thickness?(a.moveTo(b-l.thickness/2,Math.round((c+e)/2)-p),a.lineTo(d+l.thickness/2,Math.round((c+e)/2)-p)):0<t.thickness&&(a.moveTo(Math.round((d+
...
this));this.stripLines=[];if(this.options.stripLines&&0<this.options.stripLines.length)for(a=0;a<this.options.stripLines.length;a++)this.stripLines.push(new N(this.chart,this.options.stripLines[a],a,++this.chart._eventManager.lastObjectId,this));this.options.crosshair&&(this.crosshair=new ca(this.chart,this.options.crosshair,this));this._titleTextBlock=null;this.hasOptionChanged("viewportMinimum")&&null===this.viewportMinimum&&(this.options.viewportMinimum=void 0,this.sessionVariables.viewportMinimum=
...
new Sa(this,this.options.toolbar);if(this.options.zoomEnabled||this.panEnabled){if(this._zoomButton)U(this._zoomButton,{borderRight:this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor}),this._zoomButton.title=this._cultureInfo.zoomText;else{var d=!1;ta(this._zoomButton=document.createElement("button"));ua(this,this._zoomButton,"pan");this._zoomButton.title=this._cultureInfo.panText;this._toolBar.appendChild(this._zoomButton);
this._zoomButton.style.borderRight=this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor;V(this._zoomButton,"touchstart",function(a){d=!0},this.allDOMEventHandlers);V(this._zoomButton,"click",function(){a.zoomEnabled?(a.zoomEnabled=!1,a.panEnabled=!0,ua(a,a._zoomButton,"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,ua(a,a._zoomButton,"pan"));a.render()},this.allDOMEventHandlers);V(this._zoomButton,"mousemove",function(){d?d=!1:(U(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,
color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&U(a._zoomButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers);V(this._zoomButton,"mouseout",function(){d||(U(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&U(a._zoomButton.childNodes[0],{WebkitFilter:"invert(0%)",
filter:"invert(0%)"}))},this.allDOMEventHandlers)}this._resetButton?(U(this._resetButton,{borderRight:this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor}),this._resetButton.title=this._cultureInfo.resetText):(d=!1,ta(this._resetButton=document.createElement("button")),ua(this,this._resetButton,"reset"),this._resetButton.style.borderRight=(this.exportEnabled?this.toolbar.buttonBorderThickness:0)+"px solid "+
this.toolbar.buttonBorderColor,this._toolBar.appendChild(this._resetButton),V(this._resetButton,"touchstart",function(a){d=!0},this.allDOMEventHandlers),V(this._resetButton,"click",function(){a.toolTip.hide();a.toolTip&&a.toolTip.enabled&&a.toolTip.dispatchEvent("hidden",{chart:a,toolTip:a.toolTip},a.toolTip);a.zoomEnabled||a.panEnabled?(a.zoomEnabled=!0,a.panEnabled=!1,ua(a,a._zoomButton,"pan"),a._defaultCursor="default",a.overlaidCanvas.style.cursor=a._defaultCursor):(a.zoomEnabled=!1,a.panEnabled=
!1);if(a.sessionVariables.axisX)for(var b=0;b<a.sessionVariables.axisX.length;b++)a.sessionVariables.axisX[b].newViewportMinimum=null,a.sessionVariables.axisX[b].newViewportMaximum=null;if(a.sessionVariables.axisX2)for(b=0;b<a.sessionVariables.axisX2.length;b++)a.sessionVariables.axisX2[b].newViewportMinimum=null,a.sessionVariables.axisX2[b].newViewportMaximum=null;if(a.sessionVariables.axisY)for(b=0;b<a.sessionVariables.axisY.length;b++)a.sessionVariables.axisY[b].newViewportMinimum=null,a.sessionVariables.axisY[b].newViewportMaximum=
null;if(a.sessionVariables.axisY2)for(b=0;b<a.sessionVariables.axisY2.length;b++)a.sessionVariables.axisY2[b].newViewportMinimum=null,a.sessionVariables.axisY2[b].newViewportMaximum=null;a.resetOverlayedCanvas();0>=navigator.userAgent.search("MSIE")&&U(a._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"});ta(a._zoomButton,a._resetButton);a.stockChart&&(a.stockChart._rangeEventParameter={stockChart:a.stockChart,source:"chart",index:a.stockChart.charts.indexOf(a),minimum:null,
...
V(this._resetButton,"mousemove",function(){d||(U(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&U(a._resetButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers),V(this._resetButton,"mouseout",function(){d||(U(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),
...
!1;gb(this);"none"!==this._toolBar.style.display&&this._zoomButton&&(this.panEnabled?ua(a,a._zoomButton,"zoom"):ua(a,a._zoomButton,"pan"),a._resetButton.getAttribute("state")!==a._cultureInfo.resetText&&ua(a,a._resetButton,"reset"));this.options.toolTip&&this.toolTip.options!==this.options.toolTip&&(this.toolTip.options=this.options.toolTip);for(var c in this.toolTip.options)this.toolTip.options.hasOwnProperty(c)&&this.toolTip.updateOption(c)};m.prototype._updateSize=function(){var a;a=[this.canvas,
...
m.prototype._initialize=function(){this.isNavigator=s(this.parent)||s(this.parent._defaultsKey)||"Navigator"!==this.parent._defaultsKey?!1:!0;this._animator?this._animator.cancelAllAnimations():this._animator=new W(this);this.removeAllEventListeners();this.disableToolTip=!1;this._axes=[];this.funnelPyramidClickHandler=this.pieDoughnutClickHandler=null;this._updateOptions();this.animatedRender=w&&this.animationEnabled&&0===this.renderCount;this._updateSize();this.clearCanvas();this.ctx.beginPath();
...
0<=m._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new H(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);"error"===b.type&&(b.linkedDataSeriesIndex=s(this.options.data[c].linkedDataSeriesIndex)?c-1:this.options.data[c].linkedDataSeriesIndex,0>b.linkedDataSeriesIndex||b.linkedDataSeriesIndex>=this.options.data.length||"number"!==typeof b.linkedDataSeriesIndex||"error"===this.options.data[b.linkedDataSeriesIndex].type)&&(b.linkedDataSeriesIndex=null);null===b.name&&
...
a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=[],t=[],B=Infinity,k=-Infinity,n=0;n<a.dataSeriesIndexes.length;n++){var p=this.data[a.dataSeriesIndexes[n]],q=0,g=!1,r=!1,h;if("normal"===p.axisPlacement||"xySwapped"===p.axisPlacement)var m=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,
...
b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&r<b&&(c.viewPortMin=r):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(t=!0),B[b]=B[b]?B[b]+Math.abs(e):Math.abs(e))}}n.axisX.valueType=n.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=s(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=
...
(t=!0,b=k.dataPoints[n].x.getTime()):b=k.dataPoints[n].x;if((e=k.dataPoints[n].y)&&e.length){f=Math.min.apply(null,e);l=Math.max.apply(null,e);r=!0;for(var y=0;y<e.length;y++)null===e.k&&(r=!1);r&&(p||(h=g),g=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);l>d.max&&(d.max=l);0<n&&(a.axisX.logarithmic?(r=b/k.dataPoints[n-1].x,1>r&&(r=1/r),c.minDiff>r&&1!==r&&(c.minDiff=r)):(r=b-k.dataPoints[n-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r)),e&&(null!==e[0]&&k.dataPoints[n-1].y&&null!==
k.dataPoints[n-1].y[0])&&(a.axisY.logarithmic?(r=e[0]/k.dataPoints[n-1].y[0],1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e[0]-k.dataPoints[n-1].y[0],0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r))));if(!(b<m)||p){if(!p&&(p=!0,0<n)){n-=2;g=h;continue}if(b>u&&!q)q=!0;else if(b>u&&q)continue;k.dataPoints[n].label&&(a.axisX.labels[b]=k.dataPoints[n].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(y=0;y<e.length;y++)if(null===e[y]&&g<b){c.viewPortMin=
...
this._axes[l].dataInfo.min;b=(this._axes[l].dataInfo.max+1-B)*Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold)||10,10)/100;var k=this._axes[l].dataInfo._dataRanges,n,p,f=[];if(this._axes[l].dataInfo.dataPointYPositiveSums){var q=this._axes[l].dataInfo.dataPointYPositiveSums;n=k;for(t in q)if(q.hasOwnProperty(t)&&!isNaN(t)&&(p=q[t],!s(p))){var g=Math.floor((p-B)/b);p<n[g].min&&(n[g].min=p);p>n[g].max&&(n[g].max=p)}delete this._axes[l].dataInfo.dataPointYPositiveSums}if(this._axes[l].dataInfo.dataPointYNegativeSums){q=
this._axes[l].dataInfo.dataPointYNegativeSums;n=k;for(t in q)q.hasOwnProperty(t)&&!isNaN(t)&&(p=-1*q[t],s(p)||(g=Math.floor((p-B)/b),p<n[g].min&&(n[g].min=p),p>n[g].max&&(n[g].max=p)));delete this._axes[l].dataInfo.dataPointYNegativeSums}for(t=0;t<k.length-1;t++)if(n=k[t].max,isFinite(n))for(;t<k.length-1;)if(B=k[t+1].min,isFinite(B)){p=B-n;p>b&&f.push({diff:p,start:n,end:B});break}else t++;if(this._axes[l].scaleBreaks.customBreaks)for(t=0;t<this._axes[l].scaleBreaks.customBreaks.length;t++)for(b=
...
this.stockChart._rangeEventParameter,this.stockChart)),this.render(),this._dispatchRangeEvent("rangeChanged","zoom"),this.stockChart&&(this.stockChart.navigator&&this.stockChart.navigator.enabled)&&(this.stockChart._rangeEventParameter.type="rangeChanged",this.stockChart.dispatchEvent("rangeChanged",this.stockChart._rangeEventParameter,this.stockChart)),l&&(this.zoomEnabled&&"none"===this._zoomButton.style.display)&&(Ka(this._zoomButton,this._resetButton),ua(this,this._zoomButton,"pan"),ua(this,this._resetButton,
...
(p.logarithmic&&r<Math.pow(p.dataInfo.minDiff,3)||!p.logarithmic&&r<3*Math.abs(p.dataInfo.minDiff))||q<p.minimum||g>p.maximum))B.push(p),n.push({val1:q,val2:g}),t=!0;else if(!e){t=!1;break}}return{isValid:t,axesWithValidRange:B,axesRanges:n}};m.prototype.preparePlotArea=function(){var a=this.plotArea;!w&&(0<a.x1||0<a.y1)&&a.ctx.translate(a.x1,a.y1);if((this.axisX[0]||this.axisX2[0])&&(this.axisY[0]||this.axisY2[0])){var d=this.axisX[0]?this.axisX[0].lineCoordinates:this.axisX2[0].lineCoordinates;
...
b=0,e=0,f=0,l=f=e=0,t=0,B=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var n=this._indexLabels[a],p=n.chartType.toLowerCase(),q,g,l=la("indexLabelFontColor",n.dataPoint,n.dataSeries),r=la("indexLabelFontSize",n.dataPoint,n.dataSeries),t=la("indexLabelFontFamily",n.dataPoint,n.dataSeries),B=la("indexLabelFontStyle",n.dataPoint,n.dataSeries),k=la("indexLabelFontWeight",n.dataPoint,n.dataSeries),h=la("indexLabelBackgroundColor",n.dataPoint,n.dataSeries);q=la("indexLabelMaxWidth",n.dataPoint,n.dataSeries);
g=la("indexLabelWrap",n.dataPoint,n.dataSeries);var m=la("indexLabelLineDashType",n.dataPoint,n.dataSeries),u=la("indexLabelLineColor",n.dataPoint,n.dataSeries),y=s(n.dataPoint.indexLabelLineThickness)?s(n.dataSeries.options.indexLabelLineThickness)?0:n.dataSeries.options.indexLabelLineThickness:n.dataPoint.indexLabelLineThickness,b=0<y?Math.min(10,("normal"===this.plotInfo.axisPlacement?this.plotArea.height:this.plotArea.width)<<0):0,z={percent:null,total:null},C=null;if(0<=n.dataSeries.type.indexOf("stacked")||
...
this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))z="auto",t=4;else if(0<=p.indexOf("stacked"))"auto"===z&&(z="inside");else if("bubble"===p||"scatter"===p)z="inside";q=n.point.x-("horizontal"===C?B/2:B/2-r/2);"inside"!==z?(e=c.y1,f=c.y2,0<v?(g=n.point.y+("horizontal"===C?r/2:0)-k-t-b,g<e&&(g="auto"===z?Math.max(n.point.y,e)+r/2+t:e+r/2+t,x=g+k>n.point.y)):(g=n.point.y+r/2+t+b,g>f-k&&(g="auto"===z?Math.min(n.point.y,f)+r/2-k-t:f+r/2-k,x=g<n.point.y))):(e=Math.max(n.bounds.y1,
c.y1),f=Math.min(n.bounds.y2,c.y2-k+r/2),b=0<=p.indexOf("range")||"error"===p?0<v?Math.max(n.bounds.y1,c.y1)+r/2+t:Math.min(n.bounds.y2,c.y2)+r/2-k+t:(Math.max(n.bounds.y1,c.y1)+Math.min(n.bounds.y2,c.y2))/2-k/2+r/2+("horizontal"===C?t:0),0<v?(g=Math.max(n.point.y,b),g<e&&("bubble"===p||"scatter"===p)&&(g=Math.max(n.point.y-k-t,c.y1+t))):(g=Math.min(n.point.y,b),g>f-k-t&&("bubble"===p||"scatter"===p)&&(g=Math.min(n.point.y+t,c.y2-k-t))),g=Math.min(g,f))}else 0<=p.indexOf("line")||0<=p.indexOf("area")||
...
n.point.y<c.y2||!x))&&(d.lineWidth=y,d.strokeStyle=u?u:"gray",d.setLineDash&&d.setLineDash(O(m,y)),d.beginPath(),d.moveTo(n.point.x,n.point.y),0<=p.indexOf("bar")||"error"===p&&n.axisSwapped?d.lineTo(q+(0<n.direction?-l:B+l)+("vertical"===C?-r/2:0),g+("vertical"===C?-k/2:k/2-r/2)-t):0<=p.indexOf("column")||"error"===p&&!n.axisSwapped?d.lineTo(q+B/2-("horizontal"===C?0:r/2),g+("vertical"===C?(g-k<n.point.y?0:-k)+t:(g-r/2<n.point.y?k:0)-r/2)):d.lineTo(q+B/2-("horizontal"===C?0:r/2),g+("vertical"===
C?g-k<n.point.y?0:-k:(g-r/2<n.point.y?k:0)-r/2)),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)n=this._indexLabels[a],h=la("indexLabelBackgroundColor",n.dataPoint,n.dataSeries),n.dataSeries.indexLabelBackgroundColor=s(h)?w?"transparent":null:h;return d};m.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:
...
dataSeriesIndex:B};r=Q(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var m=!0,u=0,y,s;c.beginPath();if(0<n.length){for(var C=!1,u=0;u<n.length;u++)if(y=n[u].x.getTime?n[u].x.getTime():n[u].x,!(y<a.axisX.dataInfo.viewPortMin||y>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!C)))if("number"!==typeof n[u].y)0<u&&!(k.connectNullData||C||m)&&(c.stroke(),w&&b.stroke()),C=
!0;else{y=a.axisX.convertValueToPixel(y);s=a.axisY.convertValueToPixel(n[u].y);var D=k.dataPointIds[u];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:u,x1:y,y1:s};m||C?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(y,s),w&&b.lineTo(y,s)):(c.beginPath(),c.moveTo(y,s),w&&(b.beginPath(),
b.moveTo(y,s))),C=m=!1):(c.lineTo(y,s),w&&b.lineTo(y,s),0==u%500&&(c.stroke(),c.beginPath(),c.moveTo(y,s),w&&(b.stroke(),b.beginPath(),b.moveTo(y,s))));l={x:y,y:s};u<n.length-1&&(h!==(n[u].lineColor||r)||p!==(n[u].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(y,s),h=n[u].lineColor||r,c.strokeStyle=h,c.setLineDash&&(n[u].lineDashType?(p=n[u].lineDashType,c.setLineDash(O(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<n[u].markerSize||0<k.markerSize){var A=k.getMarkerProperties(u,
y,s,c);f.push(A);D=Q(D);w&&f.push({x:y,y:s,ctx:b,type:A.type,size:A.size,color:D,borderColor:D,borderThickness:A.borderThickness})}(n[u].indexLabel||k.indexLabel||n[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:n[u],dataSeries:k,point:{x:y,y:s},direction:0>n[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();w&&b.stroke()}}$.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
...
k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:B};r=Q(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var m=!0,u=0,y,s;c.beginPath();if(0<n.length){for(var C=!1,u=0;u<n.length;u++)if(y=n[u].getTime?n[u].x.getTime():n[u].x,!(y<a.axisX.dataInfo.viewPortMin||y>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!C)))if("number"!==typeof n[u].y)0<
u&&!(k.connectNullData||C||m)&&(c.stroke(),w&&b.stroke()),C=!0;else{var D=s;y=a.axisX.convertValueToPixel(y);s=a.axisY.convertValueToPixel(n[u].y);var A=k.dataPointIds[u];this._eventManager.objectMap[A]={id:A,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:u,x1:y,y1:s};m||C?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),
c.lineTo(y,D),c.lineTo(y,s),w&&(b.lineTo(y,D),b.lineTo(y,s))):(c.beginPath(),c.moveTo(y,s),w&&(b.beginPath(),b.moveTo(y,s))),C=m=!1):(c.lineTo(y,D),w&&b.lineTo(y,D),c.lineTo(y,s),w&&b.lineTo(y,s),0==u%500&&(c.stroke(),c.beginPath(),c.moveTo(y,s),w&&(b.stroke(),b.beginPath(),b.moveTo(y,s))));l={x:y,y:s};u<n.length-1&&(h!==(n[u].lineColor||r)||p!==(n[u].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(y,s),h=n[u].lineColor||r,c.strokeStyle=h,c.setLineDash&&(n[u].lineDashType?(p=n[u].lineDashType,
c.setLineDash(O(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<n[u].markerSize||0<k.markerSize)D=k.getMarkerProperties(u,y,s,c),f.push(D),A=Q(A),w&&f.push({x:y,y:s,ctx:b,type:D.type,size:D.size,color:A,borderColor:A,borderThickness:D.borderThickness});(n[u].indexLabel||k.indexLabel||n[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:n[u],dataSeries:k,point:{x:y,y:s},direction:0>n[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();
...
var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],t=0;t<a.dataSeriesIndexes.length;t++){var B=a.dataSeriesIndexes[t],k=this.data[B];b.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(b.setLineDash){var q=O(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=O(p,k.lineThickness);b.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:B};r=Q(r);e.strokeStyle=r;e.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,
4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];b.strokeStyle=r;var m=0,u,y,s=[];b.beginPath();if(0<n.length)for(y=!1,m=0;m<n.length;m++)if(u=n[m].getTime?n[m].x.getTime():n[m].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!y)))if("number"!==typeof n[m].y)0<m&&!y&&(k.connectNullData?b.setLineDash&&(0<s.length&&(k.options.nullDataLineDashType||!n[m-1].lineDashType))&&(s[s.length-1].newLineDashArray=q,p=k.nullDataLineDashType):
(d(s),s=[])),y=!0;else{u=a.axisX.convertValueToPixel(u);y=a.axisY.convertValueToPixel(n[m].y);var C=k.dataPointIds[m];this._eventManager.objectMap[C]={id:C,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:m,x1:u,y1:y};s[s.length]={x:u,y:y};m<n.length-1&&(h!==(n[m].lineColor||r)||p!==(n[m].lineDashType||k.lineDashType))&&(h=n[m].lineColor||r,s[s.length-1].newStrokeStyle=h,b.setLineDash&&(n[m].lineDashType?(p=n[m].lineDashType,s[s.length-1].newLineDashArray=O(p,k.lineThickness)):(p=k.lineDashType,
s[s.length-1].newLineDashArray=g)));if(0<n[m].markerSize||0<k.markerSize){var D=k.getMarkerProperties(m,u,y,b);l.push(D);C=Q(C);w&&l.push({x:u,y:y,ctx:e,type:D.type,size:D.size,color:C,borderColor:C,borderThickness:D.borderThickness})}(n[m].indexLabel||k.indexLabel||n[m].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[m],dataSeries:k,point:{x:u,y:y},direction:0>n[m].y===a.axisY.reversed?1:-1,color:r});y=!1}d(s)}$.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,
...
B=r[f].x,!(B<a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){l=a.axisX.convertValueToPixel(B);t=a.axisY.convertValueToPixel(r[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?l-p<<0:l+p<<0,u;0<=r[f].y?u=k:(u=t,t=k);t>u&&(b=t,t=u,u=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];ea(c,l,t,m,u,b,0,null,h&&0<=r[f].y,
0>r[f].y&&h,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:t,x2:m,y2:u};b=Q(b);w&&ea(this._eventManager.ghostCtx,l,t,m,u,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:r[f],dataSeries:g,point:{x:l+(m-l)/2,y:0>r[f].y===a.axisY.reversed?t:u},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:l,
y1:Math.min(t,u),x2:m,y2:Math.max(t,u)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();
...
m=this.data[h],u=m.dataPoints;if(0<u.length){var s=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){n=a.axisX.convertValueToPixel(b);var z=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=z+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(p=a.axisY.convertValueToPixel(t[b]),
...
this.dataPointWidth:Infinity,n));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&n<k)&&(n=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));g<k&&(g=k);g>n&&(g=n);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],
m=this.data[h],u=m.dataPoints;if(0<u.length)for(var s=5<g&&m.bevelEnabled?!0:!1,k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){n=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?100*(u[k].y/a.dataPointYSums[b]):0;var z=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=z+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y){t[b]=p+
...
l=a.axisY.convertValueToPixel(r[f].y);t=a.axisX.reversed?t+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:t-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?t-p<<0:t+p<<0,u;0<=r[f].y?u=k:(u=l,l=k);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];ea(c,u,t,l,m,b,0,null,h,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:u,y1:t,x2:l,y2:m};b=
Q(b);w&&ea(this._eventManager.ghostCtx,u,t,l,m,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",dataPoint:r[f],dataSeries:g,point:{x:0<=r[f].y?l:u,y:t+(m-t)/2},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(u,l),y1:t,x2:Math.max(u,l),y2:m},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
...
k&&(g=k);g>p&&(g=p);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],m=this.data[h],u=m.dataPoints;if(0<u.length){var s=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():
u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){p=a.axisX.convertValueToPixel(b);var z=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=z+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(D=f[b]?f[b]:q,f[b]=n=a.axisY.convertValueToPixel(t[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)B[b]=u[k].y+(B[b]?B[b]:0),n=l[b]?
l[b]:q,l[b]=D=a.axisY.convertValueToPixel(B[b]);else if(n=a.axisY.convertValueToPixel(u[k].y),0<=u[k].y){var A=f[b]?f[b]:0;D=q+A;n+=A;f[b]=A+(n-D)}else A=l[b]?l[b]:0,D=n-A,n=q-A,l[b]=A+(n-D);b=u[k].color?u[k].color:m._colorSet[k%m._colorSet.length];ea(c,D,z,n,C,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:D,y1:z,x2:n,y2:C};b=Q(b);w&&ea(this._eventManager.ghostCtx,D,z,n,C,b,0,null,!1,!1,!1,
...
q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderArea=function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=z:0>a.axisY.viewportMaximum?C=t.y1:0<a.axisY.viewportMinimum&&(C=z),f.lineTo(m,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(m,C),l.lineTo(D.x,C),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,u),l.beginPath(),l.moveTo(m,u),D={x:m,y:u})}
...
x1:m,y1:u};0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(h,m,u,f),B.push(s),Y=Q(Y),w&&B.push({x:m,y:u,ctx:l,type:s.type,size:s.size,color:Y,borderColor:Y,borderThickness:s.borderThickness}));(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[h],dataSeries:g,point:{x:m,y:u},direction:0>r[h].y===a.axisY.reversed?1:-1,color:A})}b();$.drawMarkers(B)}}w&&(e.drawImage(this._preRenderCanvas,
...
t.y1,t.width,t.height);b.clip();w&&(e.beginPath(),e.rect(t.x1,t.y1,t.width,t.height),e.clip());for(var B=0;B<a.dataSeriesIndexes.length;B++){var k=a.dataSeriesIndexes[B],n=this.data[k],p=n.dataPoints,l=n.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:k};l=Q(l);e.fillStyle=l;var l=[],q=0,g,r,h=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),m,u=null,s=[];if(0<p.length){var z=n._colorSet[q%n._colorSet.length],C=n.lineColor=n.options.lineColor||
z,D=C;b.fillStyle=z;b.strokeStyle=C;b.lineWidth=n.lineThickness;var A="solid";if(b.setLineDash){var x=O(n.nullDataLineDashType,n.lineThickness),A=n.lineDashType,E=O(A,n.lineThickness);b.setLineDash(E)}for(r=!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!r)))if("number"!==typeof p[q].y)0<q&&!r&&(n.connectNullData?b.setLineDash&&(0<s.length&&(n.options.nullDataLineDashType||!p[q-1].lineDashType))&&
(s[s.length-1].newLineDashArray=x,A=n.nullDataLineDashType):(d(),s=[])),r=!0;else{g=a.axisX.convertValueToPixel(g);r=a.axisY.convertValueToPixel(p[q].y);var K=n.dataPointIds[q];this._eventManager.objectMap[K]={id:K,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:r};s[s.length]={x:g,y:r};q<p.length-1&&(D!==(p[q].lineColor||C)||A!==(p[q].lineDashType||n.lineDashType))&&(D=p[q].lineColor||C,s[s.length-1].newStrokeStyle=D,b.setLineDash&&(p[q].lineDashType?(A=p[q].lineDashType,s[s.length-
1].newLineDashArray=O(A,n.lineThickness)):(A=n.lineDashType,s[s.length-1].newLineDashArray=E)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<n.markerSize)){var aa=n.getMarkerProperties(q,g,r,b);l.push(aa);K=Q(K);w&&l.push({x:g,y:r,ctx:e,type:aa.type,size:aa.size,color:K,borderColor:K,borderThickness:aa.borderThickness})}(p[q].indexLabel||n.indexLabel||p[q].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:n,point:{x:g,y:r},direction:0>
...
b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStepArea=function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=z:0>a.axisY.viewportMaximum?C=t.y1:0<a.axisY.viewportMinimum&&(C=z),f.lineTo(m,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(m,C),l.lineTo(D.x,
...
k.y1,k.width,k.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStackedArea=function(a){function d(){if(!(1>k.length)){for(0<A.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&s.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=A.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(s.closePath(),s.fill(),s.beginPath());k=[]}}var c=
a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=[],t=this.plotArea,h=[],k=[],n=[],p=[],q=0,g,r,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),s=this._eventManager.ghostCtx,u,y,z;w&&s.beginPath();b.save();w&&s.save();b.beginPath();b.rect(t.x1,t.y1,t.width,t.height);b.clip();w&&(s.beginPath(),s.rect(t.x1,t.y1,t.width,t.height),s.clip());for(var e=[],C=0;C<a.dataSeriesIndexes.length;C++){var D=a.dataSeriesIndexes[C],
A=this.data[D],v=A.dataPoints;A.dataPointIndexes=[];for(q=0;q<v.length;q++)D=v[q].x.getTime?v[q].x.getTime():v[q].x,A.dataPointIndexes[D]=q,e[D]||(n.push(D),e[D]=!0);n.sort(Pa)}for(C=0;C<a.dataSeriesIndexes.length;C++){D=a.dataSeriesIndexes[C];A=this.data[D];v=A.dataPoints;y=!0;k=[];q=A.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:D};q=Q(q);s.fillStyle=q;if(0<n.length){var e=A._colorSet[0],x=A.lineColor=A.options.lineColor||e,K=x;b.fillStyle=e;b.strokeStyle=x;b.lineWidth=
A.lineThickness;z="solid";if(b.setLineDash){var aa=O(A.nullDataLineDashType,A.lineThickness);z=A.lineDashType;var E=O(z,A.lineThickness);b.setLineDash(E)}for(var Y=!0,q=0;q<n.length;q++){var f=n[q],fa=null,fa=0<=A.dataPointIndexes[f]?v[A.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!A.connectNullData||!Y)))if("number"!==typeof fa.y)A.connectNullData||(Y||y)||d(),Y=!0;else{g=a.axisX.convertValueToPixel(f);var ma=h[f]?h[f]:0;if(a.axisY.logarithmic||
a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=fa.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(fa.y),r-=ma;k.push({x:g,y:m-ma});h[f]=m-r;y||Y?(!y&&A.connectNullData?(b.setLineDash&&(A.options.nullDataLineDashType||z===A.lineDashType&&A.lineDashType!==A.nullDataLineDashType)&&(y=k.pop(),z=k[k.length-1],d(),b.moveTo(u.x,u.y),k.push(z),k.push(y),z=A.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,
r),w&&s.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(s.beginPath(),s.moveTo(g,r))),Y=y=!1):(b.lineTo(g,r),w&&s.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&s.moveTo(g,r),k.push({x:g,y:m-ma})));u={x:g,y:r};q<v.length-1&&(K!==(v[q].lineColor||x)||z!==(v[q].lineDashType||A.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:m-ma}),K=v[q].lineColor||x,b.strokeStyle=K,b.setLineDash&&(v[q].lineDashType?(z=v[q].lineDashType,b.setLineDash(O(z,A.lineThickness))):(z=A.lineDashType,b.setLineDash(E))));
if(0<=A.dataPointIndexes[f]){var F=A.dataPointIds[A.dataPointIndexes[f]];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:A.dataPointIndexes[f],x1:g,y1:r}}0<=A.dataPointIndexes[f]&&0!==fa.markerSize&&(0<fa.markerSize||0<A.markerSize)&&(ma=A.getMarkerProperties(A.dataPointIndexes[f],g,r,b),l.push(ma),f=Q(F),w&&l.push({x:g,y:r,ctx:s,type:ma.type,size:ma.size,color:f,borderColor:f,borderThickness:ma.borderThickness}));(fa.indexLabel||A.indexLabel||fa.indexLabelFormatter||
...
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),s.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<A.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&z.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=A.fillOpacity;b.fill();
b.globalAlpha=1;b.beginPath();w&&(z.closePath(),z.fill(),z.beginPath());k=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,t=[],h=[],k=[],n=[],p=[],q=0,g,r,m,s,u,y=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),z=this._eventManager.ghostCtx;b.save();w&&z.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(z.beginPath(),z.rect(l.x1,l.y1,l.width,l.height),z.clip());
for(var e=[],C=0;C<a.dataSeriesIndexes.length;C++){var v=a.dataSeriesIndexes[C],A=this.data[v],x=A.dataPoints;A.dataPointIndexes=[];for(q=0;q<x.length;q++)v=x[q].x.getTime?x[q].x.getTime():x[q].x,A.dataPointIndexes[v]=q,e[v]||(n.push(v),e[v]=!0);n.sort(Pa)}for(C=0;C<a.dataSeriesIndexes.length;C++){v=a.dataSeriesIndexes[C];A=this.data[v];x=A.dataPoints;s=!0;e=A.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:v};e=Q(e);z.fillStyle=e;k=[];if(0<n.length){var e=A._colorSet[q%
A._colorSet.length],E=A.lineColor=A.options.lineColor||e,K=E;b.fillStyle=e;b.strokeStyle=E;b.lineWidth=A.lineThickness;u="solid";if(b.setLineDash){var aa=O(A.nullDataLineDashType,A.lineThickness);u=A.lineDashType;var F=O(u,A.lineThickness);b.setLineDash(F)}for(var Y=!0,q=0;q<n.length;q++){var f=n[q],fa=null,fa=0<=A.dataPointIndexes[f]?x[A.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!A.connectNullData||!Y)))if("number"!==typeof fa.y)A.connectNullData||
...
A.lineDashType!==A.nullDataLineDashType)&&(s=k.pop(),u=k[k.length-1],d(),b.moveTo(m.x,m.y),k.push(u),k.push(s),u=A.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,r),w&&z.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(z.beginPath(),z.moveTo(g,r))),Y=s=!1):(b.lineTo(g,r),w&&z.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&z.moveTo(g,r),k.push({x:g,y:y-ba})));m={x:g,y:r};q<x.length-1&&(K!==(x[q].lineColor||E)||u!==(x[q].lineDashType||A.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:y-
ba}),K=x[q].lineColor||E,b.strokeStyle=K,b.setLineDash&&(x[q].lineDashType?(u=x[q].lineDashType,b.setLineDash(O(u,A.lineThickness))):(u=A.lineDashType,b.setLineDash(F))));if(0<=A.dataPointIndexes[f]){var G=A.dataPointIds[A.dataPointIndexes[f]];this._eventManager.objectMap[G]={id:G,objectType:"dataPoint",dataSeriesIndex:v,dataPointIndex:A.dataPointIndexes[f],x1:g,y1:r}}0<=A.dataPointIndexes[f]&&0!==fa.markerSize&&(0<fa.markerSize||0<A.markerSize)&&(ba=A.getMarkerProperties(q,g,r,b),t.push(ba),f=Q(G),
...
animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderCandlestick=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,t=0,h,k,n,p,q,g,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,f=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?
...
"number"===typeof y[t].y[1]&&"number"===typeof y[t].y[2]&&"number"===typeof y[t].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(y[t].y[0]);n=a.axisY.convertValueToPixel(y[t].y[1]);p=a.axisY.convertValueToPixel(y[t].y[2]);q=a.axisY.convertValueToPixel(y[t].y[3]);var C=h-r/2<<0,D=C+r<<0,f=u.options.fallingColor?u.fallingColor:u._colorSet[0],e=y[t].color?y[t].color:u._colorSet[0],A=Math.round(Math.max(1,0.15*r)),x=0===A%2?0:0.5,E=u.dataPointIds[t];this._eventManager.objectMap[E]=
{id:E,objectType:"dataPoint",dataSeriesIndex:v,dataPointIndex:t,x1:C,y1:k,x2:D,y2:n,x3:h,y3:p,x4:h,y4:q,borderThickness:A,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=A;b.lineWidth=Math.max(A,4);"candlestick"===u.type?(c.moveTo(h-x,n),c.lineTo(h-x,Math.min(k,q)),c.stroke(),c.moveTo(h-x,Math.max(k,q)),c.lineTo(h-x,p),c.stroke(),ea(c,C,Math.min(k,q),D,Math.max(k,q),y[t].y[0]<=y[t].y[3]?u.risingColor:f,A,e,z,z,!1,!1,u.fillOpacity),w&&(e=Q(E),b.strokeStyle=e,b.moveTo(h-x,n),b.lineTo(h-x,Math.min(k,
q)),b.stroke(),b.moveTo(h-x,Math.max(k,q)),b.lineTo(h-x,p),b.stroke(),ea(b,C,Math.min(k,q),D,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===u.type&&(c.moveTo(h-x,n),c.lineTo(h-x,p),c.stroke(),c.beginPath(),c.moveTo(h,k),c.lineTo(C,k),c.stroke(),c.beginPath(),c.moveTo(h,q),c.lineTo(D,q),c.stroke(),w&&(e=Q(E),b.strokeStyle=e,b.moveTo(h-x,n),b.lineTo(h-x,p),b.stroke(),b.beginPath(),b.moveTo(h,k),b.lineTo(C,k),b.stroke(),b.beginPath(),b.moveTo(h,q),b.lineTo(D,q),b.stroke()));(y[t].indexLabel||u.indexLabel||
...
if(0<z.length)for(var C=5<r&&y.bevelEnabled?!0:!1,l=0;l<z.length;l++)if(z[l].getTime?g=z[l].x.getTime():g=z[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(z[l].y)&&z[l].y.length&&"number"===typeof z[l].y[0]&&"number"===typeof z[l].y[1]&&"number"===typeof z[l].y[2]&&"number"===typeof z[l].y[3]&&"number"===typeof z[l].y[4]&&5===z[l].y.length){t=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(z[l].y[0]);k=a.axisY.convertValueToPixel(z[l].y[1]);n=a.axisY.convertValueToPixel(z[l].y[2]);
p=a.axisY.convertValueToPixel(z[l].y[3]);q=a.axisY.convertValueToPixel(z[l].y[4]);var D=t-r/2<<0,A=t+r/2<<0,e=z[l].color?z[l].color:y._colorSet[0],x=Math.round(Math.max(1,0.15*r)),E=0===x%2?0:0.5,K=z[l].whiskerColor?z[l].whiskerColor:z[l].color?y.whiskerColor?y.whiskerColor:z[l].color:y.whiskerColor?y.whiskerColor:e,aa="number"===typeof z[l].whiskerThickness?z[l].whiskerThickness:"number"===typeof y.options.whiskerThickness?y.whiskerThickness:x,F=z[l].whiskerDashType?z[l].whiskerDashType:y.whiskerDashType,
...
y.stemDashType,H=z[l].lineColor?z[l].lineColor:z[l].color?y.lineColor?y.lineColor:z[l].color:y.lineColor?y.lineColor:e,N="number"===typeof z[l].lineThickness?z[l].lineThickness:"number"===typeof y.options.lineThickness?y.lineThickness:x,R=z[l].lineDashType?z[l].lineDashType:y.lineDashType,M=1===Math.round(N)%2?0.5:0,V=y.upperBoxColor,wa=y.lowerBoxColor,qa=s(y.options.fillOpacity)?1:y.fillOpacity,P=y.dataPointIds[l];this._eventManager.objectMap[P]={id:P,objectType:"dataPoint",dataSeriesIndex:u,dataPointIndex:l,
x1:D,y1:h,x2:A,y2:k,x3:t,y3:n,x4:t,y4:p,y5:q,borderThickness:x,color:e,stemThickness:ba,stemColor:ma,whiskerThickness:aa,whiskerLength:Y,whiskerColor:K,lineThickness:N,lineColor:H};c.save();0<ba&&(c.beginPath(),c.strokeStyle=ma,c.lineWidth=ba,c.setLineDash&&c.setLineDash(O(J,ba)),c.moveTo(t-G,k),c.lineTo(t-G,h),c.stroke(),c.moveTo(t-G,p),c.lineTo(t-G,n),c.stroke());c.restore();b.lineWidth=Math.max(x,4);c.beginPath();ea(c,D,Math.min(q,k),A,Math.max(k,q),wa,0,e,m?C:!1,m?!1:C,!1,!1,qa);c.beginPath();
ea(c,D,Math.min(n,q),A,Math.max(q,n),V,0,e,m?!1:C,m?C:!1,!1,!1,qa);c.beginPath();c.lineWidth=x;c.strokeStyle=e;c.rect(D-E,Math.min(k,n)-E,A-D+2*E,Math.max(k,n)-Math.min(k,n)+2*E);c.stroke();c.save();0<N&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(O(R,N)),c.strokeStyle=H,c.lineWidth=N,c.moveTo(D,q-M),c.lineTo(A,q-M),c.stroke());c.restore();c.save();0<aa&&(c.beginPath(),c.setLineDash&&c.setLineDash(O(F,aa)),c.strokeStyle=K,c.lineWidth=aa,c.moveTo(t-Y/2<<0,p-fa),c.lineTo(t+Y/2<<0,p-
fa),c.stroke(),c.moveTo(t-Y/2<<0,h+fa),c.lineTo(t+Y/2<<0,h+fa),c.stroke());c.restore();w&&(e=Q(P),b.strokeStyle=e,b.lineWidth=ba,0<ba&&(b.moveTo(t-E-G,k),b.lineTo(t-E-G,Math.max(h,p)),b.stroke(),b.moveTo(t-E-G,Math.min(h,p)),b.lineTo(t-E-G,n),b.stroke()),ea(b,D,Math.max(k,n),A,Math.min(k,n),e,0,null,!1,!1,!1,!1),0<aa&&(b.beginPath(),b.lineWidth=aa,b.moveTo(t+Y/2,p-fa),b.lineTo(t-Y/2,p-fa),b.stroke(),b.moveTo(t+Y/2,h+fa),b.lineTo(t-Y/2,h+fa),b.stroke()));(z[l].indexLabel||y.indexLabel||z[l].indexLabelFormatter||
...
0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,f.height),b.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,t,h,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:
...
n)*k<<0,v=a.axisX.reversed?m-k<<0:m+k<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>t){var u=l;l=t;t=u}u=q.dataPointIds[f];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:m,y1:l,x2:v,y2:t};ea(c,m,l,v,t,b,0,b,r,r,!1,!1,q.fillOpacity);b=Q(u);w&&ea(this._eventManager.ghostCtx,m,l,v,t,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",
dataPoint:g[f],dataSeries:q,indexKeyword:0,point:{x:m+(v-m)/2,y:g[f].y[1]>=g[f].y[0]?t:l},direction:g[f].y[1]>=g[f].y[0]?-1:1,bounds:{x1:m,y1:Math.min(l,t),x2:v,y2:Math.max(l,t)},color:b}),this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:1,point:{x:m+(v-m)/2,y:g[f].y[1]>=g[f].y[0]?l:t},direction:g[f].y[1]>=g[f].y[0]?1:-1,bounds:{x1:m,y1:Math.min(l,t),x2:v,y2:Math.max(l,t)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation=
...
b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(A?v:1)))<<0:0.03*this.width);u=this.options.dataPointWidth?this.dataPointWidth:0.9*((b?l.height:l.width)*(a.axisX.logarithmic?Math.log(m)/Math.log(a.axisX.range):Math.abs(m)/Math.abs(a.axisX.range))/(A?v:1))<<0;this.dataPointMaxWidth&&e>t&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,t));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&t<e)&&(t=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));u<e&&
(u=e);u>t&&(u=t);if(0<D.length)for(var F=C._colorSet,t=0;t<D.length;t++){var e=C.lineColor=C.options.color?C.options.color:F[0],K={color:D[t].whiskerColor?D[t].whiskerColor:D[t].color?C.whiskerColor?C.whiskerColor:D[t].color:C.whiskerColor?C.whiskerColor:e,thickness:s(D[t].whiskerThickness)?C.whiskerThickness:D[t].whiskerThickness,dashType:D[t].whiskerDashType?D[t].whiskerDashType:C.whiskerDashType,length:s(D[t].whiskerLength)?s(C.options.whiskerLength)?u:C.options.whiskerLength:D[t].whiskerLength,
trimLength:s(D[t].whiskerLength)?s(C.options.whiskerLength)?50:0:0};K.length="number"===typeof K.length?0>=K.length?0:K.length>=u?u:K.length:"string"===typeof K.length?parseInt(K.length)*u/100>u?u:parseInt(K.length)*u/100>u:u;K.thickness="number"===typeof K.thickness?0>K.thickness?0:Math.round(K.thickness):2;var aa={color:D[t].stemColor?D[t].stemColor:D[t].color?C.stemColor?C.stemColor:D[t].color:C.stemColor?C.stemColor:e,thickness:D[t].stemThickness?D[t].stemThickness:C.stemThickness,dashType:D[t].stemDashType?
D[t].stemDashType:C.stemDashType};aa.thickness="number"===typeof aa.thickness?0>aa.thickness?0:Math.round(aa.thickness):2;D[t].getTime?r=D[t].x.getTime():r=D[t].x;if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax)&&!s(D[t].y)&&D[t].y.length&&"number"===typeof D[t].y[0]&&"number"===typeof D[t].y[1]){var ja=a.axisX.convertValueToPixel(r);b?k=ja:h=ja;ja=a.axisY.convertValueToPixel(D[t].y[0]);b?n=ja:q=ja;ja=a.axisY.convertValueToPixel(D[t].y[1]);b?p=ja:g=ja;b?(q=a.axisX.reversed?k+(A?
v:1)*u/2-(A?E-1:0)*u<<0:k-(A?v:1)*u/2+(A?E-1:0)*u<<0,g=a.axisX.reversed?q-u<<0:q+u<<0):(n=a.axisX.reversed?h+(A?v:1)*u/2-(A?E-1:0)*u<<0:h-(A?v:1)*u/2+(A?E-1:0)*u<<0,p=a.axisX.reversed?n-u<<0:n+u<<0);!b&&q>g&&(ja=q,q=g,g=ja);b&&n>p&&(ja=n,n=p,p=ja);ja=C.dataPointIds[t];this._eventManager.objectMap[ja]={id:ja,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:t,x1:Math.min(n,p),y1:Math.min(q,g),x2:Math.max(p,n),y2:Math.max(g,q),isXYSwapped:b,stemProperties:aa,whiskerProperties:K};x(c,Math.min(n,
p),Math.min(q,g),Math.max(p,n),Math.max(g,q),e,K,aa,b);w&&x(this._eventManager.ghostCtx,n,q,p,g,e,K,aa,b);if(D[t].indexLabel||C.indexLabel||D[t].indexLabelFormatter||C.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:D[t],dataSeries:C,indexKeyword:0,point:{x:b?D[t].y[1]>=D[t].y[0]?n:p:n+(p-n)/2,y:b?q+(g-q)/2:D[t].y[1]>=D[t].y[0]?g:q},direction:D[t].y[1]>=D[t].y[0]?-1:1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b}),
this._indexLabels.push({chartType:"error",dataPoint:D[t],dataSeries:C,indexKeyword:1,point:{x:b?D[t].y[1]>=D[t].y[0]?p:n:n+(p-n)/2,y:b?q+(g-q)/2:D[t].y[1]>=D[t].y[0]?q:g},direction:D[t].y[1]>=D[t].y[0]?1:-1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
...
e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeArea=function(a){function d(){if(y){for(var a=null,c=h.length-1;0<=c;c--)a=h[c],b.lineTo(a.x,a.y2),e.lineTo(a.x,a.y2);b.closePath();b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;e.fill();if(0<n.lineThickness){b.beginPath();b.moveTo(a.x,a.y2);for(c=0;c<h.length;c++)a=h[c],
b.lineTo(a.x,a.y2);b.moveTo(h[0].x,h[0].y1);for(c=0;c<h.length;c++)a=h[c],b.lineTo(a.x,a.y1);b.stroke()}b.beginPath();b.moveTo(r,m);e.beginPath();e.moveTo(r,m);y={x:r,y:m};h=[];h.push({x:r,y1:m,y2:s})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());
for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=[],k=a.dataSeriesIndexes[t],n=this.data[k],p=n.dataPoints,f=n.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=Q(f);e.fillStyle=f;var f=[],q=!0,g=0,r,m,s,u,y=null;if(0<p.length){var z=n._colorSet[g%n._colorSet.length],v=n.lineColor=n.options.lineColor||z,D=v;b.fillStyle=z;b.strokeStyle=v;b.lineWidth=n.lineThickness;var A="solid";if(b.setLineDash){var x=O(n.nullDataLineDashType,n.lineThickness),A=n.lineDashType,E=O(A,
n.lineThickness);b.setLineDash(E)}for(var K=!0;g<p.length;g++)if(u=p[g].x.getTime?p[g].x.getTime():p[g].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!K)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){r=a.axisX.convertValueToPixel(u);m=a.axisY.convertValueToPixel(p[g].y[0]);s=a.axisY.convertValueToPixel(p[g].y[1]);q||K?(n.connectNullData&&!q?(b.setLineDash&&(n.options.nullDataLineDashType||A===n.lineDashType&&
n.lineDashType!==n.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=E,A=n.nullDataLineDashType,b.setLineDash(x)),b.lineTo(r,m),w&&e.lineTo(r,m),h.push({x:r,y1:m,y2:s})):(b.beginPath(),b.moveTo(r,m),y={x:r,y:m},h=[],h.push({x:r,y1:m,y2:s}),w&&(e.beginPath(),e.moveTo(r,m))),K=q=!1):(b.lineTo(r,m),h.push({x:r,y1:m,y2:s}),w&&e.lineTo(r,m),0==g%250&&d());u=n.dataPointIds[g];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:r,y1:m,y2:s};g<p.length-
1&&(D!==(p[g].lineColor||v)||A!==(p[g].lineDashType||n.lineDashType))&&(d(),D=p[g].lineColor||v,h[h.length-1].newStrokeStyle=D,b.strokeStyle=D,b.setLineDash&&(p[g].lineDashType?(A=p[g].lineDashType,h[h.length-1].newLineDashArray=O(A,n.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(A=n.lineDashType,h[h.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<n.markerSize)){var aa=n.getMarkerProperties(g,r,s,b);f.push(aa);var F=Q(u);w&&f.push({x:r,
y:s,ctx:e,type:aa.type,size:aa.size,color:F,borderColor:F,borderThickness:aa.borderThickness});aa=n.getMarkerProperties(g,r,m,b);f.push(aa);F=Q(u);w&&f.push({x:r,y:m,ctx:e,type:aa.type,size:aa.size,color:F,borderColor:F,borderThickness:aa.borderThickness})}if(p[g].indexLabel||n.indexLabel||p[g].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:0,point:{x:r,y:m},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?-1:1,color:z}),
this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:1,point:{x:r,y:s},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?1:-1,color:z})}else K||q||d(),K=!0;d();$.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}b.stroke()}b.beginPath()}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=a.dataSeriesIndexes[t],k=this.data[h],n=k.dataPoints,f=k.id;this._eventManager.objectMap[f]=
{objectType:"dataSeries",dataSeriesIndex:h};f=Q(f);e.fillStyle=f;var f=[],p=0,q,g,r,m=[],s=[];if(0<n.length){var u=k._colorSet[p%k._colorSet.length],y=k.lineColor=k.options.lineColor||u,z=y;b.fillStyle=u;b.lineWidth=k.lineThickness;var C="solid",D;if(b.setLineDash){var A=O(k.nullDataLineDashType,k.lineThickness),C=k.lineDashType;D=O(C,k.lineThickness)}for(g=!1;p<n.length;p++)if(q=n[p].x.getTime?n[p].x.getTime():n[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||
!g)))if(null!==n[p].y&&n[p].y.length&&"number"===typeof n[p].y[0]&&"number"===typeof n[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(n[p].y[0]);r=a.axisY.convertValueToPixel(n[p].y[1]);var x=k.dataPointIds[p];this._eventManager.objectMap[x]={id:x,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:p,x1:q,y1:g,y2:r};m[m.length]={x:q,y:g};s[s.length]={x:q,y:r};p<n.length-1&&(z!==(n[p].lineColor||y)||C!==(n[p].lineDashType||k.lineDashType))&&(z=n[p].lineColor||y,m[m.length-
1].newStrokeStyle=z,b.setLineDash&&(n[p].lineDashType?(C=n[p].lineDashType,m[m.length-1].newLineDashArray=O(C,k.lineThickness)):(C=k.lineDashType,m[m.length-1].newLineDashArray=D)));if(0!==n[p].markerSize&&(0<n[p].markerSize||0<k.markerSize)){var E=k.getMarkerProperties(p,q,g,b);f.push(E);var K=Q(x);w&&f.push({x:q,y:g,ctx:e,type:E.type,size:E.size,color:K,borderColor:K,borderThickness:E.borderThickness});E=k.getMarkerProperties(p,q,r,b);f.push(E);K=Q(x);w&&f.push({x:q,y:r,ctx:e,type:E.type,size:E.size,
color:K,borderColor:K,borderThickness:E.borderThickness})}if(n[p].indexLabel||k.indexLabel||n[p].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:0,point:{x:q,y:g},direction:n[p].y[0]<=n[p].y[1]?-1:1,color:u}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:1,point:{x:q,y:r},direction:n[p].y[0]<=n[p].y[1]?1:-1,color:u});g=!1}else 0<p&&!g&&(k.connectNullData?b.setLineDash&&
(0<m.length&&(k.options.nullDataLineDashType||!n[p-1].lineDashType))&&(m[m.length-1].newLineDashArray=A,C=k.nullDataLineDashType):(d(D,y),m=[],s=[])),g=!0;d(D,y);$.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderWaterfall=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx,e=null,f=this.plotArea,l=0,h,m,k,n,p=a.axisY.convertValueToPixel(a.axisY.logarithmic?
...
f.y1,f.width,f.height),this._eventManager.ghostCtx.clip());for(var g=0;g<a.dataSeriesIndexes.length;g++){var r=a.dataSeriesIndexes[g],s=this.data[r],v=s.dataPoints,e=s._colorSet[0];s.risingColor=s.options.risingColor?s.options.risingColor:e;s.fallingColor=s.options.fallingColor?s.options.fallingColor:"#e40a0a";var u="number"===typeof s.options.lineThickness?Math.round(s.lineThickness):1,y=1===Math.round(u)%2?-0.5:0;if(0<v.length)for(var z=5<q&&s.bevelEnabled?!0:!1,C=!1,D=null,A=null,l=0;l<v.length;l++)if(v[l].getTime?
n=v[l].x.getTime():n=v[l].x,"number"!==typeof v[l].y){if(0<l&&!C&&s.connectNullData)var x=s.options.nullDataLineDashType||!v[l-1].lineDashType?s.nullDataLineDashType:v[l-1].lineDashType;C=!0}else{h=a.axisX.convertValueToPixel(n);m=0===s.dataPointEOs[l].cumulativeSum?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSum);k=0===s.dataPointEOs[l].cumulativeSumYStartValue?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSumYStartValue);h=a.axisX.reversed?h+a.plotType.totalDataSeries*
q/2-(a.previousDataSeriesCount+g)*q<<0:h-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+g)*q<<0;var E=a.axisX.reversed?h-q<<0:h+q<<0;m>k&&(e=m,m=k,k=e);a.axisY.reversed&&(e=m,m=k,k=e);e=s.dataPointIds[l];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:l,x1:h,y1:m,x2:E,y2:k};var K=v[l].color?v[l].color:0<v[l].y?s.risingColor:s.fallingColor;ea(c,h,m,E,k,K,0,K,z,z,!1,!1,s.fillOpacity);e=Q(e);w&&ea(this._eventManager.ghostCtx,h,m,E,k,e,0,null,!1,
!1,!1,!1);var aa,K=h;aa="undefined"!==typeof v[l].isIntermediateSum&&!0===v[l].isIntermediateSum||"undefined"!==typeof v[l].isCumulativeSum&&!0===v[l].isCumulativeSum?0<v[l].y?m:k:0<v[l].y?k:m;0<l&&D&&(!C||s.connectNullData)&&(C&&c.setLineDash&&c.setLineDash(O(x,u)),c.beginPath(),c.moveTo(D,A-y),c.lineTo(K,aa-y),0<u&&c.stroke(),w&&(b.beginPath(),b.moveTo(D,A-y),b.lineTo(K,aa-y),0<u&&b.stroke()));C=!1;D=E;A=0<v[l].y?m:k;K=v[l].lineDashType?v[l].lineDashType:s.options.lineDashType?s.options.lineDashType:
"shortDash";c.strokeStyle=v[l].lineColor?v[l].lineColor:s.options.lineColor?s.options.lineColor:"#9e9e9e";c.lineWidth=u;c.setLineDash&&(K=O(K,u),c.setLineDash(K));(v[l].indexLabel||s.indexLabel||v[l].indexLabelFormatter||s.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",dataPoint:v[l],dataSeries:s,point:{x:h+(E-h)/2,y:0<=v[l].y?m:k},direction:0>v[l].y===a.axisY.reversed?1:-1,bounds:{x1:h,y1:Math.min(m,k),x2:E,y2:Math.max(m,k)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,
...
f.indexLabel?m.replaceKeywordsWithValue(f.indexLabel,f,k,e):k.indexLabelFormatter?k.indexLabelFormatter(t):k.indexLabel?m.replaceKeywordsWithValue(k.indexLabel,f,k,e):f.label?f.label:"";m._eventManager.objectMap[l]=h;h.center={x:z.x,y:z.y};h.y=f.y;h.radius=A;h.percentInnerRadius=F;h.indexLabelText=p;h.indexLabelPlacement=k.indexLabelPlacement;h.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:k.options.indexLabelLineColor?k.options.indexLabelLineColor:f.color?f.color:k._colorSet[e%
...
a.setLineDash&&a.setLineDash(O(c.indexLabelLineDashType,c.indexLabelLineThickness)),a.beginPath(),a.moveTo(d,e),a.lineTo(c.indexLabelTextBlock.x,c.indexLabelTextBlock.y),a.lineTo(c.indexLabelTextBlock.x+("left"===c.hemisphere?-p:p),c.indexLabelTextBlock.y),a.stroke()),a.lineJoin="miter");a.save()}function b(a,b){var c=0,c=a.indexLabelTextBlock.y-a.indexLabelTextBlock.height/2,d=a.indexLabelTextBlock.y+a.indexLabelTextBlock.height/2,e=b.indexLabelTextBlock.y-b.indexLabelTextBlock.height/2,f=b.indexLabelTextBlock.y+
...
15)),p.indexLabelTextBlock.y=d,p.indexLabelTextBlock.x=c,p.indexLabelAngle=Math.atan2(p.indexLabelTextBlock.y-z.y,p.indexLabelTextBlock.x-z.x))}return l}function l(){var a=m.plotArea.ctx;a.fillStyle="grey";a.strokeStyle="grey";a.font="16px Arial";a.textBaseline="middle";for(var c=a=0,d=0,l=!0,c=0;10>c&&(1>c||0<d);c++){if(k.radius||!k.radius&&"undefined"!==typeof k.innerRadius&&null!==k.innerRadius&&A-d<=E)l=!1;l&&(A-=d);d=0;if("inside"!==k.indexLabelPlacement){w=A*v;for(a=0;a<n.length;a++){var h=
g[a];h.indexLabelTextBlock.x=z.x+w*Math.cos(h.midAngle);h.indexLabelTextBlock.y=z.y+w*Math.sin(h.midAngle);h.indexLabelAngle=h.midAngle;h.radius=A;h.percentInnerRadius=F}for(var t,u,a=0;a<n.length;a++){var h=g[a],s=e(a);if(null!==s){t=g[a];u=g[s];var C=0,C=b(t,u)-r;if(0>C){for(var x=u=0,D=0;D<n.length;D++)D!==a&&g[D].hemisphere===h.hemisphere&&(g[D].indexLabelTextBlock.y<h.indexLabelTextBlock.y?u++:x++);u=C/(u+x||1)*x;var x=-1*(C-u),J=D=0;"right"===h.hemisphere?(D=f(a,u),x=-1*(C-D),J=f(s,x),+J.toFixed(y)<
+x.toFixed(y)&&+D.toFixed(y)<=+u.toFixed(y)&&f(a,-(x-J))):(D=f(s,u),x=-1*(C-D),J=f(a,x),+J.toFixed(y)<+x.toFixed(y)&&+D.toFixed(y)<=+u.toFixed(y)&&f(s,-(x-J)))}}}}else for(a=0;a<n.length;a++)h=g[a],w="pie"===k.type?0.7*A:0.8*A,s=z.x+w*Math.cos(h.midAngle),u=z.y+w*Math.sin(h.midAngle),h.indexLabelTextBlock.x=s,h.indexLabelTextBlock.y=u;for(a=0;a<n.length;a++)if(h=g[a],s=h.indexLabelTextBlock.measureText(),0!==s.height&&0!==s.width)s=s=0,"right"===h.hemisphere?(s=q.x2-(h.indexLabelTextBlock.x+h.indexLabelTextBlock.width+
p),s*=-1):s=q.x1-(h.indexLabelTextBlock.x-h.indexLabelTextBlock.width-p),0<s&&(!l&&h.indexLabelText&&(u="right"===h.hemisphere?q.x2-h.indexLabelTextBlock.x:h.indexLabelTextBlock.x-q.x1,0.3*h.indexLabelTextBlock.maxWidth>u?h.indexLabelText="":h.indexLabelTextBlock.maxWidth=0.85*u,0.3*h.indexLabelTextBlock.maxWidth<u&&(h.indexLabelTextBlock.x-="right"===h.hemisphere?2:-2)),Math.abs(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-z.y)<A||Math.abs(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/
2-z.y)<A)&&(s/=Math.abs(Math.cos(h.indexLabelAngle)),9<s&&(s*=0.3),s>d&&(d=s)),s=s=0,0<h.indexLabelAngle&&h.indexLabelAngle<Math.PI?(s=q.y2-(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2+5),s*=-1):s=q.y1-(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-5),0<s&&(!l&&h.indexLabelText&&(u=0<h.indexLabelAngle&&h.indexLabelAngle<Math.PI?-1:1,0===f(a,s*u)&&f(a,2*u)),Math.abs(h.indexLabelTextBlock.x-z.x)<A&&(s/=Math.abs(Math.sin(h.indexLabelAngle)),9<s&&(s*=0.3),s>d&&(d=s)));var H=function(a,
...
2,r=t.indexLabelTextBlock.y+t.indexLabelTextBlock.height/2,s=h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2,u=h.indexLabelTextBlock.x+h.indexLabelTextBlock.width,B=h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2;q=t.indexLabelTextBlock.x+t.indexLabelTextBlock.width<h.indexLabelTextBlock.x-p||q>u+p||m>B+p||r<s-p?!1:!0}q?(0>a&&(a=k),l!==a&&(c=l,d+=-C),0===k%Math.max(n.length/10,3)&&(f=!0)):f=!0;f&&(0<d&&0<=a&&0<=c)&&(H(d,a,c),c=a=-1,d=0)}}0<d&&H(d,a,c)})()}}function h(){m.plotArea.layoutManager.reset();
...
var A="inside"!==k.indexLabelPlacement&&a?0.75*Math.min(q.width,q.height)/2:0.92*Math.min(q.width,q.height)/2;k.radius&&(A=Ra(k.radius,A));var E="undefined"!==typeof k.innerRadius&&null!==k.innerRadius?Ra(k.innerRadius,A):0.7*A;k.radius=A;"doughnut"===k.type&&(k.innerRadius=E);var F=Math.min(E/A,(A-1)/A);this.pieDoughnutClickHandler=function(a){m.isAnimating||!s(a.dataSeries.explodeOnClick)&&!a.dataSeries.explodeOnClick||(a=a.dataPoint,a.exploded=a.exploded?!1:!0,1<this.dataPoints.length&&m._animator.animate(0,
...
function(a){function d(){for(var a=0,b=[],c=0;c<y.length;c++){if("undefined"===typeof y[c].y)return-1;y[c].y="number"===typeof y[c].y?y[c].y:0;a+=Math.abs(y[c].y)}if(0===a)return-1;for(c=b[0]=0;c<y.length;c++)b.push(Math.abs(y[c].y)*E/a);return b}function c(){var a=U,b=Z,c=M,d=$,e,f;e=Y;f=R-ba;d=Math.abs((f-e)*(b-a+(d-c))/2);c=$-M;e=f-e;f=c*(f-R);f=Math.abs(f);f=d+f;for(var d=[],g=0,k=0;k<y.length;k++){if("undefined"===typeof y[k].y)return-1;y[k].y="number"===typeof y[k].y?y[k].y:0;g+=Math.abs(y[k].y)}if(0===
g)return-1;for(var l=d[0]=0,h=0,n,p,b=b-a,l=!1,k=0;k<y.length;k++)a=Math.abs(y[k].y)*f/g,l?n=0==Number(c.toFixed(3))?0:a/c:(p=X*X*b*b-4*Math.abs(X)*a,0>p?(p=c,l=(b+p)*(e-h)/2,a-=l,n=e-h,h+=e-h,n+=0==p?0:a/p,h+=a/p,l=!0):(n=(Math.abs(X)*b-Math.sqrt(p))/2,p=b-2*n/Math.abs(X),h+=n,h>e&&(h-=n,p=c,l=(b+p)*(e-h)/2,a-=l,n=e-h,h+=e-h,n+=a/p,h+=a/p,l=!0),b=p)),d.push(n);return d}function b(){if(u&&y){for(var a,b,c,d,e,f,k,l,h,n,p,q,t,m,r,B=[],v=[],z={percent:null,total:null},C=null,A=0;A<y.length;A++)r=P[A],
r="undefined"!==typeof r.x5?(r.y2+r.y4)/2:(r.y2+r.y3)/2,r=g(r).x2+1,B[A]=N-r-V;r=0.5*V;for(var A=0,D=y.length-1;A<y.length||0<=D;A++,D--){b=u.reversed?y[D]:y[A];a=b.color?b.color:u.reversed?u._colorSet[(y.length-1-A)%u._colorSet.length]:u._colorSet[A%u._colorSet.length];c=b.indexLabelPlacement||u.indexLabelPlacement||"outside";m=b.indexLabelTextAlign||u.indexLabelTextAlign||"left";d=b.indexLabelBackgroundColor||u.indexLabelBackgroundColor||(w?"transparent":null);e=b.indexLabelFontColor||u.indexLabelFontColor||
...
"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof u.indexLabelWrap?u.indexLabelWrap:!0;t=u.dataPointIds[A];x._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataPointIndex:A,dataSeriesIndex:0,funnelSection:P[u.reversed?y.length-1-A:A]};"inside"===u.indexLabelPlacement&&(B[A]=A!==ca?u.reversed?P[A].x2-P[A].x1:P[A].x3-P[A].x4:P[A].x3-P[A].x6,20>B[A]&&(B[A]=A!==ca?u.reversed?P[A].x3-P[A].x4:P[A].x2-P[A].x1:P[A].x2-P[A].x1,B[A]/=2));t=b.indexLabelMaxWidth?b.indexLabelMaxWidth:
u.options.indexLabelMaxWidth?u.indexLabelMaxWidth:B[A];if(t>B[A]||0>t)t=B[A];v[A]="inside"===u.indexLabelPlacement?P[A].height:!1;z=x.getPercentAndTotal(u,b);if(u.indexLabelFormatter||b.indexLabelFormatter)C={chart:x.options,dataSeries:u,dataPoint:b,total:z.total,percent:z.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(C):b.indexLabel?x.replaceKeywordsWithValue(b.indexLabel,b,u,A):u.indexLabelFormatter?u.indexLabelFormatter(C):u.indexLabel?x.replaceKeywordsWithValue(u.indexLabel,b,u,A):b.label?
b.label:"";0>=n&&(n=0);1E3>t&&1E3-t<r&&(t+=1E3-t);Q.roundRect||Ba(Q);c=new ia(Q,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:k,fontWeight:h,horizontalAlign:c,textAlign:m,backgroundColor:d,maxWidth:t,maxHeight:!1===v[A]?q?4.28571429*f:1.5*f:v[A],text:b,padding:da});c.measureText();I.push({textBlock:c,id:u.reversed?D:A,isDirty:!1,lineColor:a,lineThickness:n,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=
[];e=!1;c=0;for(var g,k=N-Z-V/2,k=u.options.indexLabelMaxWidth?u.indexLabelMaxWidth>k?k:u.indexLabelMaxWidth:k,l=I.length-1;0<=l;l--){g=y[I[l].id];c=I[l];d=c.textBlock;b=(a=q(l)<P.length?I[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+da>b.y&&(e=!0);c=g.indexLabelMaxWidth||k;if(c>k||0>c)c=k;f.push(c)}if(e)for(l=I.length-1;0<=l;l--)a=P[l],I[l].textBlock.maxWidth=f[f.length-(l+1)],I[l].textBlock.measureText(),I[l].textBlock.x=N-k,c=I[l].textBlock.height<I[l].textBlock.maxHeight?I[l].textBlock.height:
I[l].textBlock.maxHeight,e=I[l].textBlock.width<I[l].textBlock.maxWidth?I[l].textBlock.width:I[l].textBlock.maxWidth,I[l].height=c,I[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,I[l].textBlock.y=c-I[l].height/2,u.reversed?(I[l].textBlock.y+I[l].height>S+C&&(I[l].textBlock.y=S+C-I[l].height),I[l].textBlock.y<qa-C&&(I[l].textBlock.y=qa-C)):(I[l].textBlock.y<S-C&&(I[l].textBlock.y=S-C),I[l].textBlock.y+I[l].height>qa+C&&(I[l].textBlock.y=qa+C-I[l].height))}function f(){var a,b,
c,d;if("inside"!==u.indexLabelPlacement)for(var e=0;e<P.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=P[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=u.reversed?"undefined"!==typeof a.x5?c>wa?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<wa?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,I[e].textBlock.x=b+V,I[e].textBlock.y=c-I[e].height/2,u.reversed?(I[e].textBlock.y+I[e].height>S+C&&(I[e].textBlock.y=S+C-I[e].height),I[e].textBlock.y<qa-C&&(I[e].textBlock.y=
qa-C)):(I[e].textBlock.y<S-C&&(I[e].textBlock.y=S-C),I[e].textBlock.y+I[e].height>qa+C&&(I[e].textBlock.y=qa+C-I[e].height)));else for(e=0;e<P.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=P[e],b=a.height,c=I[e].height,d=I[e].width,b>=c?(b=e!=ca?(a.x4+a.x3)/2-d/2:(a.x5+a.x4)/2-d/2,c=e!=ca?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,I[e].textBlock.x=b,I[e].textBlock.y=c):I[e].isDirty=!0)}function l(){function a(b,c){var d;if(0>b||b>=I.length)return 0;var e,f=I[b].textBlock;if(0>c){c*=-1;e=p(b);
...
I[t].height-e>e-I[t].textBlock.y?e+1:e-I[t].height-1))}for(l=P.length-1;0<l;l--)if(!I[l].isDirty){e=p(l);if(0>e&&(e=0,I[e].isDirty))break;if(I[l].textBlock.y<I[e].textBlock.y+I[e].height){d=d||l;f=l;for(k=0;I[f].textBlock.y<I[e].textBlock.y+I[e].height+da;){a=a||I[f].textBlock.y+I[f].height;k+=I[f].height;k+=da;f=e;if(0>=f){f=0;k+=I[f].height;break}e=p(f);if(0>e){f=0;k+=I[f].height;break}}if(f!=l){g=I[f].textBlock.y;a-=g;a=k-a;g=c(a,d,f);break}}}return g}function c(a,b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=
b;d++)e.push(P[d]);e.sort(function(a,b){return a.height-b.height});for(d=0;d<e.length;d++)if(b=e[d],f<a)g++,f+=I[b.id].height+da,I[b.id].textBlock.text="",I[b.id].indexLabelText="",I[b.id].isDirty=!0,I[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,k,l,n=1,m=0;m<2*n;m++){for(var r=I.length-1;0<=r&&!(0<=p(r)&&p(r),f=I[r],g=f.textBlock,l=(k=q(r)<P.length?I[q(r)]:null)?k.textBlock:null,d=+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&(k&&e+d+da>+l.y.toFixed(6))&&(d=g.y+d+da-l.y,
e=a(r,-d),e<d&&(0<e&&(d-=e),e=a(q(r),d),e!=d)));r--);b()}}function h(a,b){return(b<P.length?I[b].textBlock.y:u.reversed?S+C:qa+C)-(0>a?u.reversed?qa-C:S-C:I[a].textBlock.y+I[a].height+da)}function m(a,b,c){var d,e,g,l=[],h=C,p=[];-1!==b&&(0<=W.indexOf(b)?(e=W.indexOf(b),W.splice(e,1)):(W.push(b),W=W.sort(function(a,b){return a-b})));if(0===W.length)l=ha;else{e=C*(1!=W.length||0!=W[0]&&W[0]!=P.length-1?2:1)/k();for(var t=0;t<P.length;t++){if(1==W.length&&0==W[0]){if(0===t){l.push(ha[t]);d=h;continue}}else 0===
t&&(d=-1*h);l.push(ha[t]+d);if(0<=W.indexOf(t)||t<P.length&&0<=W.indexOf(t+1))d+=e}}g=function(){for(var a=[],b=0;b<P.length;b++)a.push(l[b]-P[b].y1);return a}();var q={startTime:(new Date).getTime(),duration:c||500,easingFunction:function(a,b,c,d){return L.easing.easeOutQuart(a,b,c,d)},changeSection:function(a){for(var b,c,d=0;d<P.length;d++)b=g[d],c=P[d],b*=a,"undefined"===typeof p[d]&&(p[d]=0),0>p&&(p*=-1),c.y1+=b-p[d],c.y2+=b-p[d],c.y3+=b-p[d],c.y4+=b-p[d],c.y5&&(c.y5+=b-p[d],c.y6+=b-p[d]),p[d]=
b}};a._animator.animate(0,c,function(c){var d=a.plotArea.ctx||a.ctx;ga=!0;d.clearRect(z.x1,z.y1,z.x2-z.x1,z.y2-z.y1);d.fillStyle=a.backgroundColor;d.fillRect(z.x1,z.y1,z.width,z.height);q.changeSection(c,b);var e={};e.dataSeries=u;e.dataPoint=u.reversed?u.dataPoints[y.length-1-b]:u.dataPoints[b];e.index=u.reversed?y.length-1-b:b;a.toolTip.highlightObjects([e]);for(e=0;e<P.length;e++)oa(d,P[e],u.fillOpacity);v(d);K&&("inside"!==u.indexLabelPlacement?n(d):f(),r(d));1<=c&&(ga=!1)},null,L.easing.easeOutQuart)}
...
function p(a){for(a-=1;-1<=a&&-1!=a&&I[a].isDirty;a--);return a}function q(a){for(a+=1;a<=P.length&&a!=P.length&&I[a].isDirty;a++);return a}function g(a){for(var b,c=0;c<y.length;c++)if(P[c].y1<a&&P[c].y4>a){b=P[c];break}return b?(a=b.y6?a>b.y6?b.x3+(b.x4-b.x3)/(b.y4-b.y3)*(a-b.y3):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2),{x1:a,x2:a}):-1}function r(a){for(var b=0;b<P.length;b++)I[b].isDirty||(a&&(I[b].textBlock.ctx=a),I[b].textBlock.render(!0))}function v(a){x.plotArea.layoutManager.reset();
...
J.fNg&&J.fNg(x)}var x=this;if(!(0>=a.dataSeriesIndexes.length)){for(var u=this.data[a.dataSeriesIndexes[0]],y=u.dataPoints,z=this.plotArea,C=0.025*z.width,D=0.01*z.width,A=0,E=z.height-2*C,F=Math.min(z.width-2*D,2.8*z.height),K=!1,H=0;H<y.length;H++)if(!K&&("undefined"!==typeof y[H].indexLabel&&null!==y[H].indexLabel&&0<y[H].indexLabel.toString().length)&&(K=!0),!K&&("undefined"!==typeof y[H].label&&null!==y[H].label&&0<y[H].label.toString().length)&&(K=!0),!K&&"function"===typeof u.indexLabelFormatter||
"function"===typeof y[H].indexLabelFormatter)K=!0;K=K||"undefined"!==typeof u.indexLabel&&null!==u.indexLabel&&0<u.indexLabel.toString().length;"inside"!==u.indexLabelPlacement&&K||(D=(z.width-0.75*F)/2);var H=z.x1+D,N=z.x2-D,Y=z.y1+C,R=z.y2-C,Q=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=u.length&&(u.dataPoints&&u.visible)&&0!==y.length){var ba,G;a=75*F/100;var V=30*(N-a)/100;"funnel"===u.type?(ba=s(u.options.neckHeight)?0.35*E:u.neckHeight,G=s(u.options.neckWidth)?0.25*a:u.neckWidth,"string"===
typeof ba&&ba.match(/%$/)?(ba=parseInt(ba),ba=ba*E/100):ba=parseInt(ba),"string"===typeof G&&G.match(/%$/)?(G=parseInt(G),G=G*a/100):G=parseInt(G),ba>E?ba=E:0>=ba&&(ba=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===u.type&&(G=ba=0,u.reversed=u.reversed?!1:!0);var D=H+a/2,U=H,Z=H+a,S=u.reversed?R:Y,M=D-G/2,$=D+G/2,wa=u.reversed?Y+ba:R-ba,qa=u.reversed?Y:R;a=[];var D=[],P=[],F=[],T=Y,ca,X=(wa-S)/(M-U),ea=-X,H="area"===(u.valueRepresents?u.valueRepresents:"height")?c():d();if(-1!==H){if(u.reversed)for(F.push(T),
G=H.length-1;0<G;G--)T+=H[G],F.push(T);else for(G=0;G<H.length;G++)T+=H[G],F.push(T);if(u.reversed)for(G=0;G<H.length;G++)F[G]<wa?(a.push(M),D.push($),ca=G):(a.push((F[G]-S+X*U)/X),D.push((F[G]-S+ea*Z)/ea));else for(G=0;G<H.length;G++)F[G]<wa?(a.push((F[G]-S+X*U)/X),D.push((F[G]-S+ea*Z)/ea),ca=G):(a.push(M),D.push($));for(G=0;G<H.length-1;G++)T=u.reversed?y[y.length-1-G].color?y[y.length-1-G].color:u._colorSet[(y.length-1-G)%u._colorSet.length]:y[G].color?y[G].color:u._colorSet[G%u._colorSet.length],
G===ca?P.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:$,y3:wa,x4:D[G+1],y4:F[G+1],x5:a[G+1],y5:F[G+1],x6:M,y6:wa,id:G,height:F[G+1]-F[G],color:T}):P.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:D[G+1],y3:F[G+1],x4:a[G+1],y4:F[G+1],id:G,height:F[G+1]-F[G],color:T});var da=2,I=[],ga=!1,W=[],ha=[],H=!1;a=a=0;Ca(W);for(G=0;G<y.length;G++)y[G].exploded&&(H=!0,u.reversed?W.push(y.length-1-G):W.push(G));Q.clearRect(z.x1,z.y1,z.width,z.height);Q.fillStyle=x.backgroundColor;Q.fillRect(z.x1,z.y1,z.width,z.height);
if(K&&u.visible&&(b(),f(),e(),"inside"!==u.indexLabelPlacement)){l();for(G=0;G<y.length;G++)I[G].isDirty||(a=I[G].textBlock.x+I[G].width,a=(N-a)/2,0==G&&(A=a),A>a&&(A=a));for(G=0;G<P.length;G++)P[G].x1+=A,P[G].x2+=A,P[G].x3+=A,P[G].x4+=A,P[G].x5&&(P[G].x5+=A,P[G].x6+=A),I[G].textBlock.x+=A}for(G=0;G<P.length;G++)A=P[G],oa(Q,A,u.fillOpacity),ha.push(A.y1);v(Q);K&&u.visible&&("inside"===u.indexLabelPlacement||x.animationEnabled||n(Q),x.animationEnabled||r());if(!K)for(G=0;G<y.length;G++)A=u.dataPointIds[G],
a={id:A,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:P[u.reversed?y.length-1-G:G]},x._eventManager.objectMap[A]=a;!x.animationEnabled&&H?m(x,-1,0):x.animationEnabled&&!x.animatedRender&&m(x,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ga&&!x.isAnimating&&(s(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=u.reversed?y.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===u.type||"pyramid"===u.type)u.reversed?y[y.length-1-a].exploded=
...
a?da(g,d.yValueFormatString?d.yValueFormatString:c.yValueFormatString?c.yValueFormatString:c.yValueFormatString="#,##0.########",f._cultureInfo):"z"===a?da(g,d.zValueFormatString?d.zValueFormatString:c.zValueFormatString?c.zValueFormatString:c.zValueFormatString="#,##0.########",f._cultureInfo):g})};na(F,T);F.prototype.setLayout=function(){var a=this.dockInsidePlotArea?this.chart.plotArea:this.chart,d=a.layoutManager.getFreeSpace(),c=null,b=0,e=0,f=0,l=0,h=this.markerMargin=this.chart.options.legend&&
!s(this.chart.options.legend.markerMargin)?this.chart.options.legend.markerMargin:0.3*this.fontSize;this.height=0;var m=[],k=[];if("top"===this.verticalAlign||"bottom"===this.verticalAlign)this.orientation="horizontal",c=this.verticalAlign,f=this.maxWidth=null!==this.maxWidth?this.maxWidth:d.width,l=this.maxHeight=null!==this.maxHeight?this.maxHeight:0.5*d.height;else if("center"===this.verticalAlign){this.orientation="vertical";if("left"===this.horizontalAlign||"center"===this.horizontalAlign||"right"===
...
Math.max(1,Math.round(0.2*w)):0,g=this.chart.replaceKeywordsWithValue(g,z,p,y),q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:w,dataSeriesIndex:n,dataPointIndex:y,markerBorderColor:v,markerBorderThickness:u};(z.showInLegend||p.showInLegend&&!1!==z.showInLegend)&&m.push(q)}}!0===this.reversed&&m.reverse();if(0<m.length){p=null;r=g=z=y=0;z=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,f):this.itemMaxWidth=Math.min(this.itemWidth,
...
q.textBlock.width;q.y2=this.chart._eventManager.objectMap[q.id].y2=q.textBlock.y+q.textBlock.height-this.lineHeight/2}h+=n}};na(H,T);H.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===a||"stackedLine"===a||"bubble"===a||"scatter"===a||"stackedArea"===a||"stackedColumn100"===a||"stackedLine100"===a||"stackedArea100"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===
...
{x1:l+U,y1:h,x2:l+U,y2:k,height:Math.abs(k-h)},"inside"===b[g].labelPlacement&&0<g&&(b[g].lineCoordinates.x1=b[g].lineCoordinates.x1+(D[g]-(b[g]._titleTextBlock?b[g]._titleTextBlock.height:0))-("outside"===b[g].tickPlacement?b[g].tickLength:0)-2,b[g].lineCoordinates.x2=b[g].lineCoordinates.x1+b[g].lineThickness/2),b[g].bounds={x1:l,y1:h,x2:m+(D[g]+U),y2:k,width:m-l,height:k-h},b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.height?b[g].titleMaxWidth:
...
[];A=[];F=[];v=[];E=[];u=[];N=[];for(O=[];4>w;){T=U=V=S=Z=M=W=e=R=Q=G=X=0;if(a&&0<a.length)for(F=[],g=U=0;g<a.length;g++)F.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateWidth():0)),U+=F[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else F.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));N.push(F);if(d&&0<d.length)for(v=[],g=T=0;g<d.length;g++)v.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateWidth():0)),T+=v[g],W+=d[g]?d[g].margin:0;else v.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():
0));O.push(v);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},l=Math.round(f.x1+U+e),m=Math.round(f.x2-T-W>n.width-10?n.width-10:f.x2-T-W),c[g].labelAutoFit&&!s(y)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,y):0===c[g].labelAngle?Math.max(l,y/2):l),0<!d.length&&(m=0<c[g].labelAngle?m-z/2:0===c[g].labelAngle?m-z/2:m)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=m,c[g].lineCoordinates.width=Math.abs(m-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},l=Math.round(f.x1+U+e),m=Math.round(f.x2-T-W>b[g].chart.width-10?b[g].chart.width-10:f.x2-T-W),b[g]&&b[g].labelAutoFit&&!s(x)&&(0<!a.length&&(l=0<b[g].labelAngle?Math.max(l,x):0===b[g].labelAngle?Math.max(l,x/2):l),0<!d.length&&(m-=D/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=m,b[g].lineCoordinates.width=Math.abs(m-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=
0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width);if(c&&0<c.length)for(p=[],g=S=0;g<c.length;g++)p.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateHeight():0)),S+=p[g]+c[g].margin,M+=c[g].margin;else p.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateHeight():0));E.push(p);if(b&&0<b.length)for(A=[],g=V=0;g<b.length;g++)A.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateHeight():0)),V+=A[g],Z+=b[g].margin;else A.push(Math.ceil(b[0]?
...
0<a.getSeconds()||0<a.getMilliseconds())a.setMonth(a.getMonth()+1),a.setDate(1),a.setHours(0),a.setMinutes(0),a.setSeconds(0),a.setMilliseconds(0)}else"year"===this.intervalType&&(0<a.getMonth()||1<a.getDate()||0<a.getHours()||0<a.getMinutes()||0<a.getSeconds()||0<a.getMilliseconds())&&(a.setFullYear(a.getFullYear()+1),a.setMonth(0),a.setDate(1),a.setHours(0),a.setMinutes(0),a.setSeconds(0),a.setMilliseconds(0));return a};na(S,T);na(X,T);X.prototype.createUserOptions=function(a){if("undefined"!==
...
this.ctx,c=this.ctx.globalAlpha;this.ctx=a||this.ctx;this.ctx.save();this.ctx.beginPath();this.ctx.rect(this.chart.plotArea.x1,this.chart.plotArea.y1,this.chart.plotArea.width,this.chart.plotArea.height);this.ctx.clip();var b=this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.startValue),e=this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.endValue);this.ctx.strokeStyle=this.lineColor;this.ctx.fillStyle=this.color;this.ctx.beginPath();this.ctx.globalAlpha=1;Q(this.id);var f,h,m,s,k,n;a=Math.max(this.spacing,
3);var p=Math.max(0,this.lineThickness);this.ctx.lineWidth=p;this.ctx.setLineDash&&this.ctx.setLineDash(O(this.lineDashType,p));if("bottom"===this.scaleBreaks.parent._position||"top"===this.scaleBreaks.parent._position)if(b=1===p%2?(b.x<<0)+0.5:b.x<<0,h=1===p%2?(e.x<<0)+0.5:e.x<<0,"top"===this.scaleBreaks.parent._position?(e=this.chart.plotArea.y1,m=this.chart.plotArea.y2+p/2+0.5<<0):(e=this.chart.plotArea.y2,m=this.chart.plotArea.y1-p/2+0.5<<0,a*=-1),this.bounds={x1:b-p/2,y1:e,x2:h+p/2,y2:m},this.ctx.moveTo(b,
...
this.type){f=-1;k=e+a;s=b+a;n=(m-k)/a/2;for(q=0;q<n;q++)this.ctx.lineTo(s,k),s+=2*f*a,k+=2*a,f*=-1;this.ctx.lineTo(s,k);s+=h-b;for(q=0;q<n+1;q++)this.ctx.lineTo(s,k),s+=2*f*a,k-=2*a,f*=-1;this.ctx.lineTo(s+f*a,k+a)}}else if("left"===this.scaleBreaks.parent._position||"right"===this.scaleBreaks.parent._position)if(e=1===p%2?(e.y<<0)+0.5:e.y<<0,m=1===p%2?(b.y<<0)+0.5:b.y<<0,"left"===this.scaleBreaks.parent._position?(b=this.chart.plotArea.x1,h=this.chart.plotArea.x2+p/2+0.5<<0):(b=this.chart.plotArea.x2,
h=this.chart.plotArea.x1-p/2+0.5<<0,a*=-1),this.bounds={x1:b,y1:e-p/2,x2:h,y2:m+p/2},this.ctx.moveTo(b,e),"straight"===this.type||"left"===this.scaleBreaks.parent._position&&0>=a||"right"===this.scaleBreaks.parent._position&&0<=a)this.ctx.lineTo(h,e),this.ctx.lineTo(h,m),this.ctx.lineTo(b,m);else if("wavy"===this.type){s=b;k=e;f=0.5;n=(h-s)/a/3;for(q=0;q<n;q++)this.ctx.bezierCurveTo(s+a,k+f*a,s+2*a,k+f*a,s+3*a,k),s+=3*a,f*=-1;this.ctx.bezierCurveTo(s+a,k+f*a,s+2*a,k+f*a,s+3*a,k);k=m;f*=-1;this.ctx.lineTo(s,
k);for(q=0;q<n;q++)this.ctx.bezierCurveTo(s-a,k+f*a,s-2*a,k+f*a,s-3*a,k),s-=3*a,f*=-1}else if("zigzag"===this.type){f=1;k=e-a;s=b+a;n=(h-s)/a/2;for(q=0;q<n;q++)this.ctx.lineTo(s,k),k+=2*f*a,s+=2*a,f*=-1;this.ctx.lineTo(s,k);k+=m-e;for(q=0;q<n+1;q++)this.ctx.lineTo(s,k),k+=2*f*a,s-=2*a,f*=-1;this.ctx.lineTo(s+a,k+f*a)}0<p&&this.ctx.stroke();this.ctx.closePath();this.ctx.globalAlpha=this.fillOpacity;this.ctx.globalCompositeOperation="destination-over";this.ctx.fill();this.ctx.restore();this.ctx.globalAlpha=
c;this.ctx=d}};na(N,T);N.prototype.createUserOptions=function(a){if("undefined"!==typeof a||this.options._isPlaceholder){var d=0;this.parent.options._isPlaceholder&&this.parent.createUserOptions();this.options._isPlaceholder||(Ca(this.parent.stripLines),d=this.parent.options.stripLines.indexOf(this.options));this.options="undefined"===typeof a?{}:a;this.parent.options.stripLines[d]=this.options}};N.prototype.render=function(){this.ctx.save();var a=this.parent.getPixelCoordinatesOnAxis(this.value),
...
this.labelFontSize);this.labelMaxWidth=s(this.options.labelMaxWidth)?0.3*this.chart.width:this.labelMaxWidth;this.labelMaxHeight=s(this.options.labelWrap)||this.labelWrap?0.3*this.chart.height:2*this.labelFontSize;0<p&&q.setLineDash&&q.setLineDash(O(this.lineDashType,p));k=new ia(q,{x:0,y:0,padding:{top:2,right:3,bottom:2,left:4},backgroundColor:this.labelBackgroundColor,borderColor:this.labelBorderColor,borderThickness:this.labelBorderThickness,cornerRadius:this.labelCornerRadius,maxWidth:this.labelMaxWidth,
...
this.parent.convertValueToPixel(z)),u<v&&(v=u,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(z)<<0)+0.5:this.parent.convertValueToPixel(z)<<0;this.value=z;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y}):s(this.options.label)?da(c?c:y.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[x].type){v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));
C=z=u=0;for(r=x;0<=r;r--)z+=n[r].dataPoint.y,C=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,C=100*(z/n[r].dataSeries.plotUnit.dataPointYSums[C]),u=Math.abs(a-this.parent.convertValueToPixel(C)),u<v&&(v=u,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(C)<<0)+0.5:this.parent.convertValueToPixel(C)<<0;this.value=C;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:C}):s(this.options.label)?da(c?c:C,
this.valueFormatString,this.chart._cultureInfo):this.label}else m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.y)<<0,this.value=y.dataPoint.y,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y}):s(this.options.label)?da(c?c:y.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;b=e=m;f=this.chart.plotArea.y1;h=this.chart.plotArea.y2;
...
this.parent.dataSeries[x].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?Aa(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):
...
s(this.options.label)?Aa(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?da(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=y.dataPoint.x;k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2&&(k.x=this.chart.bounds.x2-k.width);k.x<this.chart.bounds.x1&&
...
this.parent.dataSeries[x].type||"stackedArea"===this.parent.dataSeries[x].type){v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));z=u=0;for(r=x;0<=r;r--)z+=n[r].dataPoint.y,u=Math.abs(d-this.parent.convertValueToPixel(z)),u<v&&(v=u,b=r);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(z)<<0)+0.5:this.parent.convertValueToPixel(z)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y}):s(this.options.label)?
...
value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?Aa(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:0<this.parent.dataSeries.length?this.parent.convertPixelToValue(a):""}):s(this.options.label)?da(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):
...
"Calibri, Arial, Georgia, serif;",this.contentDiv.style.fontWeight=this.fontWeight?this.fontWeight:"normal",this.contentDiv.style.fontStyle=this.fontStyle?this.fontStyle:w?"italic":"normal"}catch(n){}"pie"===f[0].dataSeries.type||"doughnut"===f[0].dataSeries.type||"funnel"===f[0].dataSeries.type||"pyramid"===f[0].dataSeries.type||"bar"===f[0].dataSeries.type||"rangeBar"===f[0].dataSeries.type||"stackedBar"===f[0].dataSeries.type||"stackedBar100"===f[0].dataSeries.type?a=a-10-this.container.clientWidth:
...
entries:d};this._entries=f;this.dispatchEvent("updated",d,this)}}else this.hide(),this.enabled&&this.dispatchEvent("hidden",{chart:this.chart,toolTip:this},this)}};Z.prototype.highlightObjects=function(a){var d=this.chart.overlaidCanvasCtx;if(s(this.chart.clearedOverlayedCanvas)||"toolTip"===this.chart.clearedOverlayedCanvas)this.chart.resetOverlayedCanvas(),d.clearRect(0,0,this.chart.width,this.chart.height),this.chart.clearedOverlayedCanvas="toolTip";d.save();var c=this.chart.plotArea,b=0;d.beginPath();
...
!1,!1,!1,0.3):"pie"===b.type||"doughnut"===b.type?ha(d,e.center,e.radius,"white",b.type,e.startAngle,e.endAngle,0.3,e.percentInnerRadius):"funnel"===b.type||"pyramid"===b.type?oa(d,e.funnelSection,0.3,"white"):"candlestick"===b.type?(d.globalAlpha=1,d.strokeStyle=e.color,d.lineWidth=2*e.borderThickness,b=0===d.lineWidth%2?0:0.5,d.beginPath(),d.moveTo(e.x3-b,Math.min(e.y2,e.y3)),d.lineTo(e.x3-b,Math.min(e.y1,e.y4)),d.stroke(),d.beginPath(),d.moveTo(e.x3-b,Math.max(e.y1,e.y4)),d.lineTo(e.x3-b,Math.max(e.y2,
...
"stackedColumn100"===c.type||"stackedBar"===c.type||"stackedBar100"===c.type||"stackedArea"===c.type||"stackedArea100"===c.type||"waterfall"===c.type?(this.chart.axisX&&1<this.chart.axisX.length&&(f+=m!=c.axisXIndex?c.axisX.title?c.axisX.title+"<br/>":"X:{axisXIndex}<br/>":""),f+=b.toolTipContent?b.toolTipContent:c.toolTipContent?c.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"<span>{name}:</span>&nbsp;&nbsp;{y}",m=c.axisXIndex):"bubble"===c.type?(this.chart.axisX&&1<
this.chart.axisX.length&&(f+=m!=c.axisXIndex?c.axisX.title?c.axisX.title+"<br/>":"X:{axisXIndex}<br/>":""),f+=b.toolTipContent?b.toolTipContent:c.toolTipContent?c.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"<span>{name}:</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}"):"rangeColumn"===c.type||"rangeBar"===c.type||"rangeArea"===c.type||"rangeSplineArea"===c.type||"error"===c.type?(this.chart.axisX&&1<this.chart.axisX.length&&(f+=m!=c.axisXIndex?c.axisX.title?c.axisX.title+"<br/>":
